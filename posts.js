...
const YAKKAMON_POSTS = [
  ...
  },
  {
    ...
    body: [
      ...
      "Asked directly whether two monsters with a wood boost both contribute, the answer was no. <strong>Same-named boosts don\u2019t stack.</strong> Two copies of \u201cWood Gatherer I\u201d give you the effect once. <strong>Differently named or higher-ranked boosts do stack</strong> \u2014 \u201cWood Gatherer\u201d plus \u201cExtreme Wood Gatherer\u201d is two effects.",
      "The stated intent is to remove any reason to hoard duplicates and create a strong reason to collect <em>breadth</em>. Combined with <a href=\"gameplay.html?system=type-locking\">type locking</a>, the shape of an optimal roster is now legible for the first time: <strong>wide, not deep. One excellent specialist per job beats five copies of your best monster.</strong> That rules out the strategy most players would have defaulted to, and it\u2019s the most actionable thing published all month.",
      "## 4. Rarity is fixed at species level \u2014 and rarer isn\u2019t simply stronger",
      "Two corrections that reframe the whole roster. First: <strong>rarity is set at the species level.</strong> Every individual of a species shares its tier. There is no rare version of a common monster and no legendary variant of an ordinary one. A whole category of speculation \u2014 grinding commons hoping for a lucky upgrade roll \u2014 is dead.",
      ...
      "<strong>An exclusive biome pack.</strong> Daniel Diggle, who designed the original Sunflower Land asset pack, has finished the UI HUD and given the studio early access to a biome pack covering biome types, seasons and elements, exclusive to Yakkamon. Upgraded lighting, richer ground patterns \u2014 Adam described it as a \u201cV2\u201d of the Sunflower Land look.",
      "<strong>Email login, PWA recommended, landscape.</strong> Email is the primary login method \u2014 no wallet needed to play. The PWA installed to your home screen is described as noticeably faster than a wallet\u2019s embedded browser. The game is built for landscape.",
      "<strong>Guilds are pushed back.</strong> Acknowledged as popular, described as a lot of work, explicitly behind core functionality.",
      "<strong>100,000 pre-registered trainers</strong>, up from 45,000 two weeks ago.",
      "## The honest caveats",
      "The battle screenshot that circulated is an <strong>internal dev gym</strong>, not the finished battle screen \u2014 placeholder backgrounds, rough layout. Skill counts aren\u2019t settled; the team is considering cutting to around two per monster with more passives. Real-time interaction during battles is in testing, not confirmed. The hunting mechanic itself is still described as not 100% locked. And no upkeep numbers were published beyond that single 1.6\u00d7 example.",
      "Most of the credit for the combat system went to <strong>Matt L</strong>, the studio\u2019s game design intern, who has been on the team a matter of weeks.",
  ...
  },
  {
    ...
    date: "Aug 17, 2026",
    excerpt: "The official roster sheet shows eighteen creatures against an expected 50\u201360 at launch \u2014 updated as the sheet grew, twenty-six as of Sep 13. Portraits only \u2014 no names, no types, no rarities.",
    body: [
      "<em>Update, September 13:</em> the sheet has grown to <strong>twenty-six</strong> \u2014 a horned red creature with a gold crest and flame tufts fills the last empty slot of the fourth row, and a fifth row opens with a pink, long-eared creature carrying a sack of buds and a blue-and-teal bird with a large yellow beak. The earlier twenty-three are unchanged and in the same order, with four slots in the new row still empty; the revealed share moves from roughly two-fifths of the expected 50\u201360 to nearly half. Still no names, no types, no rarities.",
  ...
  },
  {
    ...
    body: ["<em>Update, September 2:</em> the names used below have changed — the 251–500 Legendary is now called <strong>Ghost</strong> and the 501–2,000 Legendary is now <strong>Bloom</strong> (formerly Bloom and Tide). Bands and supply are unchanged; utilities are now published in the official Yakkapedia.",
      ...
      "## Your actual odds",
      "Against a field of <strong>77,763 registered trainers</strong>: a Genesis Legendary went from <strong>1.29% to 2.57%</strong> \u2014 about one in 78, now about one in 39. Storm alone is one in 1,555. Any Monster NFT is 6.43%.",
      "The field has grown 13% since we first ran these numbers, and every percentage fell with it. The bands are fixed; the queue for them is not.",
  ...
  },
  {
    ...
    body: ["<em>Update, September 2:</em> two of the four names have changed. The official Yakkapedia now runs <strong>Storm / Echo / Ghost / Bloom</strong> — the 251–500 monster called Bloom here is now <strong>Ghost</strong>, and the 501–2,000 monster called Tide is now <strong>Bloom</strong>. Same monsters, same boosts. Utilities are published too: Storm, in-range work 2× as fast (large AOE); Echo, in-range double resources (small AOE); Ghost, in-range always at max stamina (small AOE); Bloom, HP regeneration every combat turn.",
      ...
      "<strong>Storm is new and sits above everything else.</strong> The only way to be airdropped one is a top-50 finish, and the top 10 receive Storm plus a second Genesis Legendary alongside it.",
      "Until now the position was that the Legendaries are equal in power, differing in species and role. Storm is the exception \u2014 and it gives the top of the leaderboard a real gradient where ranks 1 and 99 used to receive an identical reward.",
      "## Twice as many Legendaries",
  ...
  },
  {
    ...
    body: [
      "Yakkamon has rewritten the airdrop ladder. The top 10 now receive <strong>two</strong> monsters, a new top-tier monster was added above the old ladder, and Legendary monsters now run to rank 2,000 instead of 1,000.",
      "## The new ladder",
      "<strong>1\u20133:</strong> Storm + Echo. <strong>4\u201310:</strong> Storm + Bloom. <strong>11\u201350:</strong> Storm. <strong>51\u2013250:</strong> Echo. <strong>251\u2013500:</strong> Bloom. <strong>501\u20132,000:</strong> Tide. <strong>2,001\u20135,000:</strong> Rare Egg. <strong>5,001+:</strong> no airdrop.",
      "Only the top 10 receive two monsters. Ranks 11 to 2,000 receive a single Genesis Legendary.",
      "## What changed",
      "Every band either kept the monster it was in line for \u2014 with its utility lifted \u2014 or moved up. Echo is the monster previously called Legendary Egg A, Bloom was Egg B, Tide was Egg C. <strong>Storm is new and was added above the ladder rather than pushing anyone down it.</strong>",
      "<strong>Legendary supply roughly doubled</strong>, from about 1,000 to about 2,010. The band that gained most is 1,001\u20132,000, which was in line for a Rare Egg and now receives Tide.",
      "## What to do",
      "If you were targeting a Legendary, the line moved <em>out</em> from rank 1,000 to rank 2,000 \u2014 twice as reachable. If you were targeting top 5,000, nothing changed. Monster utilities land in September."
    ]
  },
  {
