...
const SEARCH_INDEX = [
  ...
  { tag: "FAQ", title: "Is the airdrop first come, first served?", excerpt: "No. The 5,000 Genesis Monster NFTs go to the top 5,000 on the points leaderboard, not the first 5,000 to sign up.", url: "faq.html#genesis" },
