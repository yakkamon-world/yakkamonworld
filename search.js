...
const SEARCH_INDEX = [
  ...
  { tag: "News", title: "The Free-to-Play Guide to Early Access", excerpt: "The daily routine, the one date that matters, and why referrals are 60% of a realiztic free total.", url: "article-free-to-play-guide.html" },
  ...
  { tag: "FAQ", title: "Is there a difference between Legendary Egg A, B and C?", excerpt: "Yes \u2014 different utilities and a different Yakkamon each. The utilities are not finalized until after testing.", url: "faq.html#egg-tiers" },
