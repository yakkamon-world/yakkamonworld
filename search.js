...
const SEARCH_INDEX = [
  ...
  { tag: "Pre-registration", title: "Referral rules", excerpt: "A referral counts only once that friend reaches 100 points. Removed ones are deducted, and abuse can disqualify an account.", url: "pre-registration.html#referrals" },
  ...
  { tag: "News", title: "Referral Rule Change: Friends Now Need 100 Points to Count", excerpt: "A referral only counts once the trainer you referred earns 100 points. 4,783 farming accounts were banned.", url: "article-referral-rule-change-100-points.html" },
  { tag: "News", title: "Why did my referral not count?", excerpt: "Since August 2026 the friend you referred has to reach 100 points of their own before the referral pays.", url: "article-referral-rule-change-100-points.html" },
  ...
  { tag: "News", title: "How many points is a referral worth?", excerpt: "30 points per verified friend, credited once that friend reaches 100 points of their own.", url: "article-leaderboard-guideline.html" },
  ...
  { tag: "FAQ", title: "Referral rules \u2014 what counts", excerpt: "Sign-ups under 100 points don't count, nor do unverified, multi-account or bot ones. Removed referrals are deducted.", url: "faq.html#egg-tiers" },
