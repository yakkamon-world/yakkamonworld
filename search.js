...
const SEARCH_INDEX = [
  { tag: "News", title: "Official News — announcements from the Yakkamon team", excerpt: "Every dated announcement, rule change, schedule update and reveal from the official team, reported as it landed. Filtered view of the news archive.", url: "news.html?category=official" },
  { tag: "News", title: "Dev Stream recaps and gradings", excerpt: "Every Yakkamon developer stream, recapped and graded decision by decision. Filtered view of the news archive.", url: "news.html?category=devstream" },
  { tag: "News", title: "Analysis — YakkamonWorld's own readings", excerpt: "What the official posts mean for players: economy, Regions, hunting, the airdrop ladder, strategy pieces and our open corrections. Filtered view of the news archive.", url: "news.html?category=analysis" },
  { tag: "News", title: "Guides — step-by-step walkthroughs", excerpt: "The free mint, $FLOWER deposits, the leaderboard, free-to-play and the reward track, explained start to finish. Filtered view of the news archive.", url: "news.html?category=guide" },
  { tag: "News", title: "Tips — one action at a time", excerpt: "Short, single-action tips for climbing the Early Access leaderboard. Filtered view of the news archive.", url: "news.html?category=tips" },
  { tag: "News", title: "Portal Updates — what's new on YakkamonWorld", excerpt: "New pages and features on the site: the leaderboard, field guide, FAQ, tips section and YouTube channel. Filtered view of the news archive.", url: "news.html?category=portal" },
  { tag: "Help", title: "Ask me anything \u2014 the site chatbot", excerpt: "Type a question into the bar at the bottom of any page. Answers come from the official docs first, then YakkamonWorld, then the dev streams, and every reply shows its source.", url: "/#ask" },
  { tag: "News", title: "The Ronin Wave: Who Gets Yakkamon\u2019s 2,000 Gamer Mints, and How to Check If You\u2019re One of Them", excerpt: "The official Wave 3 page explained: 2,000 free mints on September 16 for wallets active in Axie Infinity, Craft World, Pixels, Ronkeverse or Moku, a Sunflower Land list to come, 42,730 candidates, lists finalized September 10.", url: "article-ronin-wave.html" },
  { tag: "News", title: "What is the Ronin Wave in the Yakkamon free mint?", excerpt: "Wave 3, September 16: 2,000 hidden Genesis NFTs for active Ronin gamers, chosen by a 90-day on-chain snapshot ending September 8. No Yakkamon rank, snapshot position or $FLOWER deposit needed.", url: "article-ronin-wave.html#at-a-glance" },
  { tag: "News", title: "Which games count for the Ronin Wave?", excerpt: "Axie Infinity (20,040 wallets), Craft World (14,422), Pixels (4,247), Ronkeverse (3,658), Moku (2,354) and a Sunflower Land list still to come. What the team counted in each, and why Pixels is so small.", url: "article-ronin-wave.html#five-games" },
  { tag: "News", title: "How is the Ronin Wave score calculated?", excerpt: "Active days across 90 days matter most; signals are weighted and capped per day; cross-game players sort to the top; bot-like, custodial and guild wallets are pushed down; contracts are excluded.", url: "article-ronin-wave.html#score" },
  { tag: "News", title: "How to check if your wallet is on the Ronin Wave list", excerpt: "Search the mega list or a per-game list for your Ronin address in lowercase 0x form, not ronin: form. Read rank, score and active_days_90d. Craft World players: check the wallet you would mint from.", url: "article-ronin-wave.html#check" },
  { tag: "News", title: "Ronin Wave: 42,730 candidates for 2,000 spots \u2014 the arithmetic", excerpt: "Under 5% of candidates get in; the dedup implies 500\u20131,991 multi-game wallets who sort to the top; and \u201c2,000 spots\u201d could mean a guaranteed list or a click race. Our reading.", url: "article-ronin-wave.html#arithmetic" },
  { tag: "News", title: "Ronin Wave candidate lists return 404", excerpt: "As of 14:00 UTC on September 8 every list link on the official page pointed to a GitHub repository that returned page not found. What to do until they open.", url: "article-ronin-wave.html" },
  { tag: "News", title: "Sunflower Land players and the Ronin Wave", excerpt: "Sunflower Land players get their own spot in Wave 3; the list lands before September 10. Plus a second route: $FLOWER earned in SFL unlocks Waves 2 and 4 with a 5 $FLOWER deposit.", url: "article-ronin-wave.html#sunflower-land" },
  { tag: "FAQ", title: "What is the Ronin Wave?", excerpt: "Wave 3 of the free mint, September 16: 2,000 hidden Genesis Yakkamon for active Ronin gamers, picked from a 90-day on-chain snapshot of five games. No rank or deposit needed; lists finalize September 10.", url: "faq.html#what-is-the-ronin-wave" },
  { tag: "FAQ", title: "How do I check if I'm on the Ronin Wave list?", excerpt: "Open the official candidate lists and search your Ronin address in lowercase 0x form, not ronin: form. Craft World players check the wallet they would mint from. Check again before September 10.", url: "faq.html#how-do-i-check-if-i-m-on-the-ronin-wave-list" },
  { tag: "FAQ", title: "How is the Ronin Wave score worked out?", excerpt: "Active days matter most, signals are capped per day, playing more than one game sorts you to the top, bots rank last. The window closed on September 8, so nothing you do now changes it.", url: "faq.html#how-is-the-ronin-wave-score-worked-out" },
  { tag: "FAQ", title: "I play Sunflower Land \u2014 am I in the Ronin Wave?", excerpt: "Probably: Sunflower Land players get their own place in Wave 3, list published before September 10. Farming on Ronin, $FLOWER activity, collectibles, Bumpkins, Farm NFTs and marketplace trades are expected to count.", url: "faq.html#i-play-sunflower-land-am-i-in-the-ronin-wave" },
  { tag: "FAQ", title: "Does the Ronin Wave affect my rank or the airdrop?", excerpt: "No. It doesn't touch the September 10 trainer snapshot or the Genesis airdrop leaderboard. It adds an extra mint if the wallet linked to your account was active in one of the five games.", url: "faq.html#does-the-ronin-wave-affect-my-rank-or-the-airdrop" },
  { tag: "News", title: "Every Wild Yakkamon Wants Something — What the Official Hunting Post Means for Players", excerpt: "The official Hunting post: spawns on an in-game clock, hunters that roam while you farm, affectionate, greedy and angry encounters, wild Legendaries, depleting grounds and a map that rotates each Season.", url: "article-hunting-explained.html" },
  { tag: "News", title: "How does hunting work in Yakkamon?", excerpt: "Send a Yakkamon to passively roam a hunting ground while you run your farm. It triggers encounters with the wild monsters living there; what it meets depends on the ground and the in-game time of day.", url: "article-hunting-explained.html" },
  { tag: "News", title: "What are affectionate, greedy and angry Yakkamon?", excerpt: "The three wild temperaments in the official Hunting post. Affectionate ones come home only if your hunter wins them over, greedy ones want resources first, angry ones start a battle a weak hunter will lose.", url: "article-hunting-explained.html" },
  { tag: "News", title: "Can you catch a Legendary Yakkamon by hunting?", excerpt: "Yes — the official Hunting post says Legendaries and Rares sporadically appear in the hunting grounds, with no schedule. Have a strong, well-supplied team ready the moment one shows up.", url: "article-hunting-explained.html" },
  { tag: "News", title: "Do hunting grounds run out?", excerpt: "Yes. The more you hunt a ground, the less populated it becomes, so the team says to spread hunts across grounds and Regions. The regeneration rate is unpublished.", url: "article-hunting-explained.html" },
  { tag: "News", title: "Does time of day matter for hunting?", excerpt: "Yes — each ground reveals different Yakkamon at different times of day. Note it is the sped-up in-game clock, not your local time, so read the HUD clock.", url: "article-hunting-explained.html" },
  { tag: "News", title: "Do Seasons change which Yakkamon you can hunt?", excerpt: "Yes. Future Seasons affect which Yakkamon are available and where, so the hunting map you master now won’t be next Chapter’s — and a species leaving the map is what closes a supply window.", url: "article-hunting-explained.html" },
  { tag: "News", title: "Tip: Deposit on Ronin If You Haven\u2019t Yet", excerpt: "Same points on either chain, but the September 14 mint is Ronin-only and gas is in RON. The next deposit is easier on the chain you will mint on.", url: "article-tip-deposit-on-ronin.html" },
  ...
  { tag: "News", title: "Which free mint waves can I mint in?", excerpt: "Ranks 1\u20131,000: Waves 1, 2, 4, 5. Ranks 1,001\u201310,000: 2, 4, 5. Ranks 10,001\u201320,000: 4, 5. Ranks 20,001\u201350,000: Wave 5 only. Waves 2 and 4 need 5 $FLOWER deposited; Wave 3 is the Ronin Wave for active Ronin gamers at any rank.", url: "article-ronin-free-mint-guide.html" },
  { tag: "News", title: "What do I need before the September 10 snapshot?", excerpt: "A verified account, the rank you want, at least 5 $FLOWER deposited for Waves 2 and 4, and a Ronin wallet linked to your Yakkamon account.", url: "article-ronin-free-mint-guide.html" },
  { tag: "News", title: "How do I mint on the Ronin Launchpad?", excerpt: "Have RON for gas in advance, open marketplace.roninchain.com/launchpads yourself, connect your linked Ronin wallet, mint when your wave opens and approve in the wallet. One NFT per wave.", url: "article-ronin-free-mint-guide.html" },
  { tag: "News", title: "Do I need a Ronin wallet for the free mint?", excerpt: "Yes. The mint is on Ronin only and gas is paid in RON. $FLOWER on Base counts for points and for the 5 $FLOWER condition, but the wallet that mints must be a linked Ronin wallet.", url: "article-ronin-free-mint-guide.html" },
  { tag: "News", title: "What are the odds of a Legendary in the free mint?", excerpt: "68 in 10,000 \u2014 about one mint in 147. 3 Storm, 5 Echo, 10 Ghost, 50 Bloom, plus 50 Rares; the other 9,882 are Uncommon with unique stats.", url: "article-ronin-free-mint-guide.html" },
  { tag: "News", title: "Free mint safety: is it really free?", excerpt: "Yes \u2014 the only cost is RON gas. Mint only at marketplace.roninchain.com, never from a DM link, and never share your recovery phrase.", url: "article-ronin-free-mint-guide.html" },
  ...
  { tag: "News", title: "When is the Yakkamon free mint?", excerpt: "September 14, 2026, on the Ronin Launchpad, running as waves over a few days. Hidden until the October 14 reveal, tradable the whole time.", url: "article-free-mint-stream-graded.html" },
  { tag: "News", title: "When is the leaderboard snapshot?", excerpt: "September 10, 2026. The rank you hold that day decides your free-mint wave \u2014 top 1,000 mint guaranteed, top 10,000 race for 3,000 supply.", url: "article-free-mint-stream-graded.html" },
  { tag: "News", title: "How do the free mint waves work?", excerpt: "Top 1,000 guaranteed; 3,000 supply for the top 10,000 with a five-flower minimum; a 2,000-mint Ronin wave (criteria published September 8, see The Ronin Wave); then ranks 1\u201320,000 and 1\u201350,000. Plus a 1,500 manual-airdrop reserve.", url: "article-free-mint-stream-graded.html" },
  ...
  { tag: "Gameplay", title: "Upkeep & Degradation \u2014 farms wear out", excerpt: "Plots degrade with use (1.6\u00d7 slower in the example shown) and refertilizing costs resources. Plot groups scale non-linearly.", url: "gameplay.html?system=upkeep" },
  ...
  { tag: "Gameplay", title: "Can I customize my land?", excerpt: "Probably not at launch. Your gym is the exception \u2014 full customization planned, and visiting trainers see it.", url: "gameplay.html?system=your-base" },
  { tag: "Home", title: "YakkamonWorld", excerpt: "The unofficial Yakkamon player portal — news, gameplay, and pre-registration all in one place.", url: "/" },
  { tag: "News", title: "Wave 5 Probably Doesn\u2019t Exist: The Free Mint by the Numbers", excerpt: "Live numbers on the free mint \u2014 133,408 registered, 5,219 depositors, 68 Legendaries in 10,000 \u2014 and what they mean wave by wave.", url: "article-free-mint-by-the-numbers.html" },
  { tag: "News", title: "What are the odds of a Legendary in the free mint?", excerpt: "1 in 147 per mint (0.68%); 1 in 85 for Rare or better; 1 in 3,333 for a Storm; 98.8% Uncommon. Five tickets only lifts the Legendary chance to 3.35%.", url: "article-free-mint-by-the-numbers.html#odds" },
  { tag: "News", title: "Does Wave 5 of the free mint exist?", excerpt: "Probably not: the wave sizes add up to 11,000 for 10,000 NFTs. If Waves 1\u20133 sell out Wave 4 has 4,000, and if Wave 4 sells out Wave 5 has nothing.", url: "article-free-mint-by-the-numbers.html#wave-5" },
  { tag: "News", title: "Will the deposit waves sell out?", excerpt: "Only 5,219 wallets have a deposit. Wave 2 sells out if 57% of them mint; Wave 4 needs 77\u201396% to come back a second day \u2014 the swing wave.", url: "article-free-mint-by-the-numbers.html#turnout" },
  { tag: "News", title: "$1.25 buys two free-mint tickets", excerpt: "5 $FLOWER is $1.25 today and unlocks Wave 2 (ranks 1\u201310,000) and Wave 4 (ranks 1\u201320,000). Withdrawable, not a fee \u2014 but the snapshot is September 10.", url: "article-free-mint-by-the-numbers.html#two-tickets" },
  { tag: "News", title: "62.5% of registered trainers have no mint wave", excerpt: "133,408 registered, the widest wave stops at rank 50,000 \u2014 83,408 people with no wave unless they are on the Ronin gamers list.", url: "article-free-mint-by-the-numbers.html#no-wave" },
  { tag: "News", title: "Where do the 68 Legendaries land, wave by wave?", excerpt: "73% chance nobody mints a Storm on day one; 49% chance a Storm goes to a Ronin gamer; the leftover Wave 4 expects 27 of the 68 Legendaries.", url: "article-free-mint-by-the-numbers.html#where-legendaries-land" },
  { tag: "News", title: "What is a hidden free-mint egg worth?", excerpt: "A lottery-ticket price: 1.35 Uncommons if a Legendary is worth 50, 1.72 at 100, 3.1 at 300. Selling at the Uncommon floor sells the ticket for the losing outcome.", url: "article-free-mint-by-the-numbers.html#hidden-value" },
  { tag: "Home", title: "Free mint countdown \u2014 wave by wave", excerpt: "Live clock to the next mint wave, plus all five dates (14\u201318 September), who can mint in each wave and the supply. Wave hours aren\u2019t published yet, so the clock assumes 00:00 UTC.", url: "/#mint-board" },

  { tag: "Early Access", title: "Early Access guide", excerpt: "Pre-registration points, tiers, the free mint and Genesis monsters — explained simply.", url: "pre-registration.html" },
  { tag: "Early Access", title: "Getting started", excerpt: "What pre-registration is, how points work, and how to earn them.", url: "pre-registration.html#getting-started" },
  { tag: "Early Access", title: "Important dates", excerpt: "Everything scheduled between now and early access \u2014 mint, reveal, leaderboard lock, airdrop, launch and the four waves.", url: "pre-registration.html#important-dates" },
  { tag: "Early Access", title: "Which free-mint wave is mine?", excerpt: "Wave 1 (Sept 14) top 1,000 guaranteed; Wave 2 (Sept 15) ranks 1\u201310,000 with 5 $FLOWER; the Ronin Wave (Sept 16); Wave 4 (Sept 17) ranks 1\u201320,000; Wave 5 (Sept 18) ranks 1\u201350,000. The board at the top of the page shows which one is next.", url: "pre-registration.html#mint-board" },
  { tag: "Early Access", title: "When does the leaderboard lock?", excerpt: "One week before early access launch. The rank you hold then is the rank your rewards are calculated on.", url: "pre-registration.html#important-dates" },
  { tag: "Early Access", title: "When do the early access waves enter?", excerpt: "Wave 1 on launch day, Wave 2 a week later, Wave 3 a week after that. Wave 4 is confirmed closer to launch.", url: "pre-registration.html#important-dates" },
  ...
  { tag: "Early Access", title: "Reward track", excerpt: "Rewards rotate on a 7-day cycle \u2014 a new claimable list every week, and each one replaces the last.", url: "pre-registration.html#reward-track" },
  { tag: "Early Access", title: "Monster Egg tiers explained", excerpt: "Platinum, Gold, Silver, Bronze and Basic \u2014 handed out in sign-up order, up to 500,000 trainers.", url: "pre-registration.html#egg-tiers" },
  { tag: "Early Access", title: "Referral rules", excerpt: "75 points each. First five are instant; after that the friend must link a wallet and deposit 100 $FLOWER of their own.", url: "pre-registration.html#referrals" },
  ...
  { tag: "News", title: "Do Discord and X still verify a referral?", excerpt: "No \u2014 dropped on August 14 because bot accounts were clearing that bar in bulk. A 100 $FLOWER deposit replaced it.", url: "article-referral-rule-change-flower-deposit.html" },
  ...
  { tag: "Early Access", title: "Genesis monsters", excerpt: "The one-time Genesis airdrop \u2014 5,000 reward eggs by points rank, with Legendary eggs going to the top 500.", url: "pre-registration.html#genesis-monsters" },
  { tag: "Early Access", title: "Free mint — September 14", excerpt: "10,000 hidden Genesis monsters on the Ronin Launchpad in five rank-gated waves, 14\u201318 September. Snapshot September 10, reveal October 14.", url: "pre-registration.html#free-mint" },
  { tag: "Early Access", title: "FLOWER deposits", excerpt: "Depositing $FLOWER early banks your balance for launch and earns pre-reg points.", url: "pre-registration.html#flower-deposits" },
  ...
  { tag: "News", title: "How to reach early access without depositing", excerpt: "Get verified, clear the one-time quests, nurture daily after 12:00 UTC, mint on September 14, and refer real people.", url: "article-free-to-play-guide.html" },
  ...
  { tag: "FAQ", title: "Hunting — every question in one place", excerpt: "New FAQ topic: hunting grounds, roaming hunters, the three temperaments, bait and lures, wild Legendaries, contract hunts, depleting grounds and Seasons.", url: "faq.html#hunting" },
  { tag: "FAQ", title: "What is a hunting ground, and where do I find one?", excerpt: "A tile on your own Region that holds wild Yakkamon; you reveal one by unlocking tiles with gathered resources. Each Region brings its own monster types.", url: "faq.html#what-is-a-hunting-ground" },
  { tag: "FAQ", title: "Does hunting run while I farm?", excerpt: "Yes — you send a Yakkamon to passively roam a ground and it triggers encounters while you run your farm. Whether it continues offline is unpublished.", url: "faq.html#does-hunting-run-while-i-farm" },
  { tag: "FAQ", title: "Which Yakkamon should I send hunting?", excerpt: "One that can fight an angry monster, win over an affectionate one, and that you can spare from a type-locked gathering line.", url: "faq.html#which-yakkamon-should-i-send-hunting" },
  { tag: "FAQ", title: "What do greedy Yakkamon want?", excerpt: "Resources — specific goods, not a generic fee. Amounts unpublished. The sink for the free, untradeable gathering layer.", url: "faq.html#what-do-greedy-yakkamon-want" },
  { tag: "FAQ", title: "What happens if my hunter loses a fight?", excerpt: "You come back empty-handed. Expect lost stamina and possibly a recovery period; no other penalty is published.", url: "faq.html#what-happens-if-my-hunter-loses" },
  { tag: "FAQ", title: "Do I need bait or lures to hunt?", excerpt: "Probably: an in-game notice said to prepare bait and berries, and the streams described crafted lures that pick a type and bait that wins monsters over.", url: "faq.html#do-i-need-bait-or-lures-to-hunt" },
  { tag: "FAQ", title: "Are the same wild Yakkamon in every Region?", excerpt: "No. Each Region has its own monster types (the Water Region has water hunting areas), and each ground changes with the in-game hour.", url: "faq.html#are-the-same-wild-yakkamon-in-every-region" },
  { tag: "FAQ", title: "Do Seasons change what I can hunt?", excerpt: "Yes — future Seasons change which Yakkamon are available and where, so the hunting map you master this Chapter won't be next Chapter's.", url: "faq.html#do-seasons-change-what-i-can-hunt" },
  { tag: "FAQ", title: "Is there a hunting schedule or spawn table?", excerpt: "No official one. Legendaries appear with no schedule to memorize; the time-of-day pattern runs on the in-game clock and is yours to learn.", url: "faq.html#is-there-a-hunting-schedule" },
  { tag: "FAQ", title: "What is a contract hunt?", excerpt: "A hunt someone else ordered. The free-mint stream said contract hunts pay coins — one of the few faucets for the currency that gates the tradeable layer.", url: "faq.html#what-is-a-contract-hunt" },
  { tag: "FAQ", title: "Will hunting be available on day one of Early Access?", excerpt: "The basic loop should be; the first NFT monster hunt is dated to Chapter 0, a month after Early Access opens.", url: "faq.html#will-hunting-be-available-on-day-one" },
  { tag: "FAQ", title: "What are affectionate, greedy and angry Yakkamon?", excerpt: "The three wild temperaments from the official Hunting post: won over by your hunter, paid off with resources, or fought. A hunting squad is three checks at once — strength, charm and stock.", url: "faq.html#what-are-affectionate-greedy-and-angry-yakkamon" },
  { tag: "FAQ", title: "Can I catch a Legendary by hunting?", excerpt: "Yes — Legendaries and Rares sporadically appear in the hunting grounds with no schedule. Keep a strong, well-supplied team ready. Rates unpublished.", url: "faq.html#can-i-catch-a-legendary-by-hunting" },
  { tag: "FAQ", title: "Does the time of day matter for hunting?", excerpt: "Yes, each ground reveals different Yakkamon at different times of day — on the in-game clock, not yours. Keep your own log of ground, hour and what appeared.", url: "faq.html#does-the-time-of-day-matter-for-hunting" },
  { tag: "FAQ", title: "Do hunting grounds run out, and what do I do about it?", excerpt: "They deplete as you hunt them; regeneration is unpublished. Spread hunts across grounds and Regions — budget a second hunting tile before the first runs dry.", url: "faq.html#do-hunting-grounds-run-out" },
  { tag: "FAQ", title: "How do I actually mint on the day?", excerpt: "RON for gas in advance, open marketplace.roninchain.com/launchpads yourself, connect your linked Ronin wallet, mint when your wave opens, approve, repeat for every wave you qualify for.", url: "faq.html#how-do-i-actually-mint-on-the-day" },
  { tag: "FAQ", title: "Is the September 10 snapshot the same as the leaderboard lock?", excerpt: "No. The snapshot only builds the mint whitelists. The lock that decides your airdrop monster, trainer number and early-access wave comes one week before early access.", url: "faq.html#is-the-10-september-snapshot-the-same-as-the-leaderboard-lock" },
  { tag: "FAQ", title: "How do I know a mint link is real?", excerpt: "The mint is free \u2014 anything charging a price or asking for wallet-wide approval is not Yakkamon. Mint only at marketplace.roninchain.com; the team never DMs links.", url: "faq.html#how-do-i-know-a-mint-link-is-real" },
  ...
  { tag: "News", title: "We Graded Every Decision From Yakkamon\u2019s First Dev Stream (August 6)", excerpt: "Nine decisions graded A to C \u2014 three A\u2019s, one C, and what we would change about the deposit economy.", url: "article-dev-stream-graded.html" },
  ...
  { tag: "News", title: "How many Monster NFTs are in the airdrop?", excerpt: "5,010 across 5,000 trainers \u2014 Storm 50, Echo 203, Ghost 256, Bloom 1,500, plus 3,000 Rare Eggs (Ghost and Bloom were Bloom and Tide when this was written).", url: "article-genesis-legendaries.html" },
  ...
  { tag: "News", title: "Meet Storm, Echo, Bloom and Tide (now Storm, Echo, Ghost and Bloom)", excerpt: "The four Genesis Legendaries have names, and Legendary monsters now run to rank 2,000 instead of 1,000.", url: "article-genesis-legendaries.html" },
  { tag: "News", title: "What are the four Genesis Legendaries?", excerpt: "Storm (top 50), Echo (51\u2013250), Ghost (251\u2013500) and Bloom (501\u20132,000) \u2014 renamed from Bloom and Tide in September. Top 10 get Storm plus a second.", url: "article-genesis-legendaries.html" },
  ...
  { tag: "Gameplay", title: "The Genesis Legendaries", excerpt: "Storm, Echo, Ghost and Bloom \u2014 supplies, utilities, AOE sizes and where every copy goes, from the official Yakkapedia.", url: "gameplay.html?system=genesis-legendaries" },
  { tag: "Gameplay", title: "Utilities & Auras", excerpt: "How a utility works: named on Legendaries, randomly rolled on Rares and Uncommons; small vs large AOE; additive and multiplicative stacking (Storm + Echo).", url: "gameplay.html?system=utilities-auras" },
  { tag: "Gameplay", title: "The Two-Track Economy", excerpt: "An infinite free-to-play layer that can't be traded, and a tradable layer gated by coins \u2014 with coin faucets limited to VIP, burning and contract hunts.", url: "gameplay.html?system=economy-layers" },
  { tag: "Gameplay", title: "What does Storm do?", excerpt: "Stormcharged: Yakkamon within range work 2\u00d7 as fast, large AOE. 75 exist \u2014 50 airdropped, 3 in the free mint, 1 raffle.", url: "gameplay.html?system=genesis-legendaries" },
  { tag: "Gameplay", title: "What does Echo do?", excerpt: "Yakkamon within range produce double resources, small AOE. 275 exist \u2014 203 airdropped, 5 in the free mint.", url: "gameplay.html?system=genesis-legendaries" },
  { tag: "Gameplay", title: "What does Ghost do?", excerpt: "Unsleeping: Yakkamon within range are always at maximum stamina, small AOE. 400 exist \u2014 256 airdropped, 10 in the free mint. Formerly called Bloom.", url: "gameplay.html?system=genesis-legendaries" },
  { tag: "Gameplay", title: "What does Bloom do?", excerpt: "Regenerates a % of Max HP every combat turn. 2,000 exist \u2014 1,500 airdropped, 50 in the free mint. Formerly called Tide.", url: "gameplay.html?system=genesis-legendaries" },
  { tag: "Gameplay", title: "What happens if I stop logging in?", excerpt: "It pauses. Bins fill, jobs stop, no decay and no neglect penalty \u2014 the team ruled out punishing absence.", url: "gameplay.html?system=upkeep" },
  { tag: "Gameplay", title: "How does hunting work?", excerpt: "A job you assign, on the in-game clock: grounds with areas and a timetable, lures by type, affectionate, greedy and angry encounters, wild Legendaries, grounds that deplete, contract hunts that pay coins.", url: "gameplay.html?system=hunting" },
  { tag: "Gameplay", title: "Do I get to act in combat?", excerpt: "Yes \u2014 \u201cmechanic swapping\u201d. Plus initiative (coin flip unless type advantage), lane order and preset 2\u20133 ability loops.", url: "gameplay.html?system=combat-system" },
  { tag: "Gameplay", title: "Is there a breeding limit?", excerpt: "Yes, scaled by rarity \u2014 commons above replacement, rares around it, some Legendaries once. Bred Yakkamon are tradable.", url: "gameplay.html?system=breeding-genetics" },
  { tag: "Gameplay", title: "13 types, no gear", excerpt: "Thirteen types at launch, one per Yakkamon (dual types later). No wearable gear \u2014 possibly one held item.", url: "gameplay.html?system=creature-collecting" },
  ...
  { tag: "News", title: "Is the free mint still October 1st?", excerpt: "No \u2014 it is September 14 on the Ronin Launchpad, in rank-gated waves, with the reveal on October 14. Get verified before the September 10 snapshot.", url: "article-dev-stream-two-recap.html" },
  ...
  { tag: "News", title: "When does the leaderboard lock?", excerpt: "No date yet, but it runs until about a week before early access and is finalized after the mint reveal in mid-October.", url: "article-dev-stream-two-recap.html" },
  ...
  { tag: "News", title: "First Yakkamon Dev Stream (August 6): Everything They Announced", excerpt: "Deposit system rebuilt with a decaying weekly multiplier, a new official X account, and PvP confirmed post-launch.", url: "article-dev-stream-aug-7-recap.html" },
  ...
  { tag: "News", title: "Referral Rule Change: Three Steps Before a Referral Counts", excerpt: "SUPERSEDED \u2014 the August 5 rule. Discord and X no longer verify a referral at all; see the August 14 change.", url: "article-referral-rule-change-100-points.html" },
  ...
  { tag: "News", title: "$FLOWER Deposits Open Sunday, August 9 at 8:00 PM ET", excerpt: "Deposit address issued, the weekly multiplier and size bonus explained, and why the docs say August 10.", url: "article-flower-deposits-open-august-9.html" },
  { tag: "News", title: "When do $FLOWER deposits open?", excerpt: "Aug 9 at 8:00 PM ET \u2014 midnight UTC, which the official docs render as August 10.", url: "article-flower-deposits-open-august-9.html" },
  { tag: "News", title: "New on the Portal: Trainer Tips", excerpt: "A new section for leaderboard tactics, with the math shown rather than asserted.", url: "article-tips-section-live.html" },
  ...
  { tag: "News", title: "News archive", excerpt: "Official news, dev stream recaps, analysis, guides, tips and portal updates in one place.", url: "news.html" },
  ...
  { tag: "News", title: "The Genesis Airdrop: 5,000 Monsters, One Chance", excerpt: "SUPERSEDED \u2014 Legendaries now go to ranks 1\u20132,000 and Rare Eggs to 2,001\u20135,000. The original July post on the 5,000-trainer airdrop, with a note pointing at the current rules.", url: "article-genesis-airdrop-5000.html" },
  { tag: "News", title: "FLOWER Deposits: Deposit Early, Climb the Board", excerpt: "SUPERSEDED \u2014 withdrawals now open at Chapter 0 and points follow the weekly multiplier. The original July explainer, with a note pointing at the current deposit guideline.", url: "article-flower-deposits-explained.html" },
  ...
  { tag: "Videos", title: "Video: Yakkamon \u2014 Ronin Free Mint Guide", excerpt: "EP 19, 7:27 \u2014 the free mint start to finish: the five waves (Sept 14\u201318) and which ones your rank unlocks, the Sept 10 snapshot, the 5 $FLOWER deposit, the Ronin wallet you need, and what to do on mint day.", url: "videos.html" },
  { tag: "Videos", title: "Video: Yakkamon \u2014 Hunting", excerpt: "EP 18, 3:01 \u2014 the official Hunting post explained: spawns on the in-game clock, hunters that roam while you farm, affectionate, greedy and angry wild Yakkamon, wild Legendaries, depleting grounds and a map that rotates each Season.", url: "videos.html" },
  { tag: "Videos", title: "Video: Dev Stream 9-1-26 Recap \u2014 Free Mint, Game Updates & Launch Calendar", excerpt: "EP 17, 4:05 \u2014 the free-mint stream in four minutes: waves, the September 10 snapshot, 68 hidden Legendaries, the game updates and the calendar to Chapter 0.", url: "videos.html" },
  ...
  { tag: "News", title: "Eighteen Yakkamon, No Names", excerpt: "First shown with 18 creatures, updated Aug 25 to 21 \u2014 portraits only, no names, types or rarities against an expected 50\u201360 at launch.", url: "article-yakkamon-roster-revealed.html" },
  { tag: "News", title: "How many Yakkamon have been revealed?", excerpt: "Twenty-three so far on the official roster sheet \u2014 a green snail-like creature with pink flowers added September 8, and the grid reordered \u2014 out of a launch roster the team puts at roughly 50 to 60 species.", url: "article-yakkamon-roster-revealed.html" },
  ...
  { tag: "Gameplay", title: "The roster so far", excerpt: "Twenty-three Yakkamon shown on the official sheet, as of September 8. Types are the missing field that decides which resources each can gather.", url: "gameplay.html#roster" },
  ...
  { tag: "Gameplay", title: "Hunting: Grounds, Clock & Temperaments", excerpt: "Its own system page. Grounds are tiles on your Regions; wild Yakkamon change with the in-game hour; a roaming hunter meets affectionate, greedy or angry monsters; Legendaries appear unannounced; grounds deplete and Seasons rotate the map.", url: "gameplay.html?system=hunting" },
  { tag: "Gameplay", title: "Crafting, Lures & Bait", excerpt: "The recipe layer: refine gathered resources into gear, lures that pick a type, bait that wins monsters over, and goods that pay greedy ones. Contract hunts pay coins.", url: "gameplay.html?system=crafting-hunting" },
  ...
  { tag: "Videos", title: "Is there a video on the airdrop change?", excerpt: "Yes \u2014 EP 11 covers the named Legendaries, the corrected supply math and the leaderboard lock rule.", url: "videos.html" },
  { tag: "Videos", title: "Video: The Reward Ladder Changed", excerpt: "A 14-minute analysis of the August 12 change. Note: its supply conclusion was later corrected \u2014 see the written correction.", url: "videos.html" },
  ...
  { tag: "Videos", title: "Is there a video on the third dev stream?", excerpt: "Yes \u2014 EP 15 covers the August 21 stream and the game economy in five minutes, with the written version linked underneath.", url: "videos.html" },
  { tag: "Videos", title: "All YakkamonWorld videos", excerpt: "All 19 episodes in one place \u2014 short explainers on pre-registration, points, deposits, the leaderboard and gameplay, each linked to the written version.", url: "videos.html" },
  ...
  { tag: "Privacy", title: "Do you use referral links?", excerpt: "Yes, and I say so. Registering through my code gets you a Gold Box and earns me points \u2014 it costs you nothing and you can ignore it.", url: "privacy.html#referral-links" },
  { tag: "Privacy", title: "Privacy \u2014 what I collect", excerpt: "Analytics only with your consent, a contact form that emails me, no ads and nothing sold. Turn analytics off any time.", url: "privacy.html" },
  ...
  { tag: "About", title: "Who writes YakkamonWorld?", excerpt: "Every article is written and published by YakkamonWorld \u2014 one person, who builds the site and plays as the trainer YakkamonW, pre-registered in Season 0 in 2026.", url: "about.html#author" },
  { tag: "About", title: "About YakkamonWorld", excerpt: "Who writes this site, where the facts come from, and what I can\u2019t do \u2014 an independent fan portal with no access to the studio.", url: "about.html" },
  ...
  { tag: "About", title: "Something on the site is wrong", excerpt: "Corrections go to the front of the queue \u2014 I fix the page and say what changed rather than editing quietly.", url: "about.html#corrections" },
  { tag: "Contact", title: "Contact me", excerpt: "Corrections, questions, tip submissions, scam reports and collaboration \u2014 pick a topic and it reaches me directly.", url: "contact.html" },
  { tag: "Contact", title: "Report a mistake on this site", excerpt: "Found something wrong? Tell me \u2014 corrections get priority and I would rather fix it than leave it up.", url: "contact.html" },
  { tag: "Contact", title: "Submit a tip or strategy", excerpt: "Send me a tactic that works. If it holds up it goes on the Tips page with your name on it.", url: "contact.html" },
  { tag: "Contact", title: "Report a scam or fake site", excerpt: "Spotted a fake Yakkamon site or impersonator account? Tell me and I will warn the community.", url: "contact.html" },
  ...
  { tag: "Leaderboard", title: "What does each leaderboard rank win?", excerpt: "Ranks 1\u20133 Storm + Echo, 4\u201310 Storm + Ghost, 11\u201350 Storm, 51\u2013250 Echo, 251\u2013500 Ghost, 501\u20132,000 Bloom, 2,001\u20135,000 Rare Egg \u2014 and nothing from 5,001st down.", url: "leaderboard.html#bands" },
  ...
  { tag: "Leaderboard", title: "How many points does each airdrop band need?", excerpt: "Live point lines for Storm, Echo, Ghost, Bloom and the Rare Egg, worked out from deposits made so far.", url: "leaderboard.html#bands" },
  ...
  { tag: "Tips", title: "Your $FLOWER deposit is also your launch war-chest", excerpt: "The docs list early-access-only offers \u2014 discounted Gems, VIP, exclusive items, Chapter 0 auctions \u2014 that only a balance already in the game can buy. First pick goes to whoever arrives with $FLOWER ready.", url: "tips.html#launch-war-chest" },
  { tag: "Tips", title: "What can I spend deposited $FLOWER on at launch?", excerpt: "Gems at early-access rates, VIP access, exclusive launch-window items, auctions from Chapter 0, and the in-game economy. Withdrawals open at Chapter 0 with early percentage limits.", url: "tips.html#launch-war-chest" },
  { tag: "Tips", title: "Deposit on Ronin if you haven\u2019t yet", excerpt: "Points are identical on Base and Ronin, but the free mint is Ronin-only with gas in RON \u2014 depositing on Ronin puts the wallet, swap and gas in place before mint day.", url: "tips.html#deposit-on-ronin" },
  { tag: "Tips", title: "I deposited on Base \u2014 do I need to bridge to Ronin?", excerpt: "No. Points and the 5 $FLOWER mint condition count on either chain; your deposit address accepts both. You only need a Ronin wallet as well, funded with RON and linked to your account, to mint.", url: "tips.html#deposit-on-ronin" },
  ...
  { tag: "Tips", title: "Trainer Tips", excerpt: "Four practical leaderboard tactics worked through with real numbers: deposit timing, nurture timing, what your deposit buys at launch, and depositing on Ronin before the mint.", url: "tips.html" },
  ...
  { tag: "FAQ", title: "FAQ", excerpt: "Every question organized by topic \u2014 pick a topic pill or filter all 85 answers.", url: "faq.html" },
  ...
  { tag: "FAQ", title: "Why didn't the multiplier drop in week 3?", excerpt: "Deposits were paused in week 2, so week 3 was held at 2.8x and the whole schedule shifted a week \u2014 the 1.0x floor now lands October 26.", url: "faq.html#why-didn-t-the-multiplier-drop-in-week-3" },
  { tag: "FAQ", title: "When do $FLOWER deposits close?", excerpt: "The final window ends November 16 at 01:59 UTC \u2014 the multiplier sits at its 1.0x floor from October 26 to the close.", url: "faq.html#when-do-flower-deposits-close" },
  ...
  { tag: "FAQ", title: "Do I need a Ronin wallet if I deposited on Base?", excerpt: "Yes \u2014 the mint is Ronin Launchpad only, from September 14. Base deposits still count for points and the 5 $FLOWER condition.", url: "faq.html#i-deposited-on-base-do-i-need-a-ronin" },
  { tag: "FAQ", title: "How many Yakkamon are there?", excerpt: "Twenty-three shown officially so far, of roughly 50\u201360 at launch \u2014 the rest arrive across chapter releases.", url: "faq.html#how-many-yakkamon-are-there" },
  ...
  { tag: "Early Access", title: "Pre-registration is open to everyone", excerpt: "Anyone can sign up with a referral code from a trainer who has already joined \u2014 no Sunflower Land account, no Bumpkin level, no wallet.", url: "pre-registration.html#referrals" },
  ...
  { tag: "FAQ", title: "What is the free mint?", excerpt: "10,000 hidden Genesis monster NFTs on the Ronin Launchpad from September 14, in five waves gated by leaderboard rank. Free bar gas; revealed October 14.", url: "faq.html#free-mint" },
  ...
  { tag: "FAQ", title: "Do I need a good rank to free mint?", excerpt: "Top 50,000 at the September 10 snapshot to be in any wave; top 1,000 for a guaranteed mint; 10,000 and 20,000 with 5 $FLOWER for Waves 2 and 4.", url: "faq.html#free-mint" },
  ...
  { tag: "FAQ", title: "When does Yakkamon launch?", excerpt: "Early access is November or December 2026, rolling out in waves; Chapter 0 a month later. The free mint is September 14, reveal October 14.", url: "faq.html#launch" },
  ...
  { tag: "FAQ", title: "What does my rank get me?", excerpt: "The full ladder from rank 1 to 100,001+ \u2014 Storm, Echo, Ghost, Bloom, Rare Egg, the waves, and the cutoff at 100,000.", url: "faq.html#ranks-tiers" },
  { tag: "FAQ", title: "How do I earn points?", excerpt: "Daily egg nurture and streaks, Discord and X quests, referrals, the September 14 free mint (250 points), and $FLOWER deposits.", url: "faq.html#ranks-tiers" },
  ...
  { tag: "FAQ", title: "When does the Genesis Drop leaderboard end?", excerpt: "Trainer numbers and tiers are revealed shortly before early access in November or December 2026; the leaderboard finalizes one week before launch.", url: "faq.html#mint-vs-airdrop" },
  ...
  { tag: "FAQ", title: "When do $FLOWER deposits open?", excerpt: "Sunday, August 9 at 8:00 PM ET \u2014 the docs say August 10 because they quote the UTC date.", url: "faq.html#flower" },
  ...
  { tag: "FAQ", title: "What happened to Tide?", excerpt: "Renamed. The 501\u20132,000 Legendary is now Bloom and the 251\u2013500 one is Ghost \u2014 same monsters, same boosts.", url: "faq.html#what-happened-to-tide" },
  { tag: "FAQ", title: "When exactly is the free mint, and what are the waves?", excerpt: "September 14 on the Ronin Launchpad, one wave a day to September 18. Top 1,000 guaranteed, the Ronin Wave for gamers from five other Ronin games on the 16th, then ranks 10,000 / 20,000 / 50,000.", url: "faq.html#when-exactly-and-what-are-the-waves" },
  { tag: "FAQ", title: "Can I mint more than once?", excerpt: "One NFT per wave per account \u2014 and you can mint in every wave you qualify for.", url: "faq.html#can-i-mint-more-than-once" },
  { tag: "FAQ", title: "What does the 5 $FLOWER deposit do?", excerpt: "It is the condition for mint Waves 2 and 4 \u2014 anti-bot, withdrawable, and already met by 3,000+ of the top 10,000.", url: "faq.html#what-does-the-5-flower-deposit-do" },
  { tag: "FAQ", title: "What is the free-mint gas fee paid in?", excerpt: "RON, on the Ronin blockchain. The amount, and whether Ronin sponsors any of it, was not known on the stream.", url: "faq.html#what-is-the-gas-fee-and-what-is-it-paid-in" },
  { tag: "FAQ", title: "What do the Genesis Legendaries actually do?", excerpt: "Storm: in-range work 2\u00d7 fast (large AOE). Echo: double resources (small). Ghost: never tired (small). Bloom: HP regen each combat turn.", url: "faq.html#what-do-the-genesis-legendaries-actually-do" },
  { tag: "FAQ", title: "Small vs large AOE", excerpt: "Small touches the job it stands on and the 2\u20133 nodes beside it; large covers a whole section of the farm.", url: "faq.html#what-s-the-difference-between-a-small-and-a-large-aoe" },
  { tag: "FAQ", title: "Do utilities stack?", excerpt: "Some add, some multiply \u2014 Storm + Echo is the confirmed multiplying pair. Same-name boosts still don\u2019t stack.", url: "faq.html#do-utilities-stack" },
  { tag: "FAQ", title: "Can I put gear on my Yakkamon?", excerpt: "No wearable gear. Possibly one held item. The Yakkamon have the stats.", url: "faq.html#can-i-put-gear-on-my-yakkamon" },
  { tag: "FAQ", title: "How many types are there?", excerpt: "Thirteen at launch, one per Yakkamon; dual types later.", url: "faq.html#how-many-types-are-there-and-can-a-yakkamon-have-two" },
  { tag: "FAQ", title: "Is combat a pure simulation?", excerpt: "No \u2014 players act inside fights via \u201cmechanic swapping\u201d. Coin-flip initiative unless a lane has type advantage.", url: "faq.html#is-combat-a-pure-simulation-or-do-i-get-to-do-anything" },
  { tag: "FAQ", title: "How does a hunt work?", excerpt: "A job you assign; lures pick a type; aggressive monsters fight, ambient ones must be charmed; the ground depletes, not the hunter.", url: "faq.html#how-does-a-hunt-actually-work" },
  { tag: "FAQ", title: "Is there a cap on working Yakkamon?", excerpt: "No \u2014 as many as you have jobs for.", url: "faq.html#is-there-a-limit-on-how-many-yakkamon-can-work-at-once" },
  { tag: "FAQ", title: "Are there evolutions?", excerpt: "Confirmed, but not at launch \u2014 the supply problem comes first.", url: "faq.html#are-there-evolutions" },
  { tag: "FAQ", title: "What are coins?", excerpt: "The in-game Web2 currency (maybe \u201cnew yen\u201d later) that gates the tradable economy. Not $FLOWER.", url: "faq.html#what-are-coins" },
  { tag: "Early Access", title: "Free mint waves (14\u201318 September)", excerpt: "Wave 1 top 1,000 guaranteed; Wave 2 ranks 1\u201310,000 with 5 $FLOWER; Wave 3 the Ronin Wave for active Axie, Craft World, Pixels, Ronkeverse, Moku and Sunflower Land players; Wave 4 ranks 1\u201320,000; Wave 5 ranks 1\u201350,000. Snapshot September 10, reveal October 14.", url: "pre-registration.html#free-mint" },
  { tag: "Early Access", title: "Chapter 0", excerpt: "One month after early access: the first NFT monster hunt, the first batch of Legendaries, auctions, the marketplace and $FLOWER withdrawals.", url: "pre-registration.html#important-dates" },
];
