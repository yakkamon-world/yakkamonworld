 ...
 },
 {
  ...
  "items": [
   ...
   },
   {
    ...
    "a": "<p>One wave a day from September 14, each with its own supply and its own list:</p>\n    <div class=\"table-scroll\"><table class=\"prereg-table\">\n      <tr><th>Wave</th><th>Date</th><th>Supply</th><th>Who</th></tr>\n      <tr><td>1</td><td>Sept 14</td><td>1,000</td><td>Top 1,000 trainers &mdash; guaranteed, at your own pace</td></tr>\n      <tr><td>2</td><td>Sept 15</td><td>3,000</td><td>Ranks 1&ndash;10,000 with a 5 $FLOWER minimum deposit</td></tr>\n      <tr><td>3 (Ronin Wave)</td><td>Sept 16</td><td>2,000</td><td>Active Ronin gamers &mdash; wallets active in Axie, Craft World, Pixels, Ronkeverse, Moku or Sunflower Land in the 90 days to September 8, plus a Ronin-team whitelist. <a href=\"#what-is-the-ronin-wave\">More below &rarr;</a></td></tr>\n      <tr><td>4</td><td>Sept 17</td><td>5,000</td><td>Ranks 1&ndash;20,000 with a 5 $FLOWER minimum deposit; ends early if the 10,000 sell out</td></tr>\n      <tr><td>5</td><td>Sept 18, 00:00 UTC</td><td>Remaining</td><td>Ranks 1&ndash;50,000</td></tr>\n    </table></div>\n    <p>A further <strong>1,500</strong> are sent manually as an ecosystem airdrop &mdash; 1,000 to top Ronin spenders, 500 to $FLOWER ecosystem players &mdash; probably a week after the mint and before the reveal. The dates after Wave 1 were described as tentative on the stream.</p>"
   },
   {
   ...
   },
   {
    ...
    "a": "<p>You need to be inside the <strong>top 50,000</strong> on the leaderboard to be in any wave, and the higher you are the more waves you're on the list for, because the brackets nest. The rank that counts is your rank at the <strong>September 10 snapshot</strong>.</p>\n    <div class=\"table-scroll\"><table class=\"prereg-table\">\n      <tr><th>Rank on Sept 10</th><th>Waves</th><th>Needs 5 $FLOWER?</th></tr>\n      <tr><td>1&ndash;1,000</td><td>1, 2, 4, 5 &mdash; Wave 1 guaranteed</td><td>For Waves 2 and 4</td></tr>\n      <tr><td>1,001&ndash;10,000</td><td>2, 4, 5</td><td>For Waves 2 and 4</td></tr>\n      <tr><td>10,001&ndash;20,000</td><td>4, 5</td><td>For Wave 4</td></tr>\n      <tr><td>20,001&ndash;50,000</td><td>5 only</td><td>No</td></tr>\n      <tr><td>50,001+</td><td>None from the leaderboard &mdash; Wave 3 only if your wallet makes the <a href=\"article-ronin-wave.html\">Ronin Wave</a> whitelist</td><td>&mdash;</td></tr>\n    </table></div>"
   },
   {
    "q": "What is the Ronin Wave?",
    "id": "what-is-the-ronin-wave",
    "a": "<p><strong>Wave 3</strong> of the free mint, on <strong>September 16</strong>: 2,000 hidden Genesis Yakkamon reserved for people already playing on Ronin. It is the one wave that ignores the Yakkamon leaderboard &mdash; no rank, no snapshot position and no $FLOWER deposit are needed. The team took a <strong>90-day on-chain snapshot ending September 8</strong> across Axie Infinity (20,040 wallets), Craft World (14,422), Pixels (4,247), Ronkeverse (3,658) and Moku (2,354) &mdash; <strong>42,730 unique candidate wallets</strong> &mdash; and a Sunflower Land list is being added before the whitelist is finalized on <strong>September 10</strong>, together with a separate whitelist from the Ronin team. The lists are candidates, not the final whitelist: 42,730 wallets for 2,000 spots. <a href=\"article-ronin-wave.html\">The full breakdown &rarr;</a></p>"
   },
   {
    "q": "How do I check if I'm on the Ronin Wave list?",
    "id": "how-do-i-check-if-i-m-on-the-ronin-wave-list",
    "a": "<p>The official <a href=\"https://docs.yakkamon.com/pre-registration/free-mint/ronin-wave\" target=\"_blank\" rel=\"noopener\">Ronin Wave page &#8599;</a> links to a mega list (every wallet, all games) and five per-game lists. Open one and search for your Ronin address in <strong>lowercase <code>0x&hellip;</code> form</strong>, not the <code>ronin:</code> form the wallet shows by default. The columns are <code>rank</code> (lower is better), <code>score</code> (higher is better), <code>active_days_90d</code>, and in the mega list <code>games</code> and <code>games_count</code>. Craft World players: the game makes an embedded smart wallet for you, so check the Ronin Wallet address you would actually mint from. Check again before 10 September, when the lists finalise. As of 8 September the list links pointed at a GitHub repository that returned &ldquo;page not found&rdquo;; if that is still the case, try again later. <a href=\"article-ronin-wave.html#check\">Step by step &rarr;</a></p>"
   },
   {
   ...
   },
   {
    ...
    "a": "<p>Probably, but the list isn't out yet. The team says Sunflower Land players get their own place in Wave 3 and that the list will be published before the whitelists finalize on September 10. It expects to count active farming on a Ronin farm over the same 90-day window, $FLOWER activity on Ronin, holding collectibles, Bumpkins and Farm NFTs, and marketplace trades. You also have a second route nobody else in the wave has: $FLOWER earned in Sunflower Land is the same token that unlocks Waves 2 and 4 &mdash; verify a Yakkamon account and deposit 5 $FLOWER before September 10. <a href=\"article-ronin-wave.html#sunflower-land\">What to check &rarr;</a></p>"
   },
   {
    "q": "Does the Ronin Wave affect my rank or the airdrop?",
    "id": "does-the-ronin-wave-affect-my-rank-or-the-airdrop",
    "a": "<p>No. It does not touch the September 10 trainer snapshot for Waves 1, 2, 4 and 5, and it does not touch the Genesis airdrop leaderboard, which keeps running until one week before early access. What it adds is an extra mint: if the Ronin wallet linked to your Yakkamon account was also active in one of the five games, you can mint in Wave 3 on top of your rank waves &mdash; one per wallet per wave. The wallet on the list must be the wallet that mints, so if your Ronin gaming and your Yakkamon account use different wallets, decide now which one Wave 3 comes from. <a href=\"article-ronin-wave.html#trainers\">If you are a trainer &rarr;</a></p>"
   },
   {
    "q": "Do I need to do anything before mint day?",
    "id": "do-i-need-to-do-anything-before-mint-day",
    "a": "<p>Four things, all before <strong>September 10</strong>:</p>\n    <ul class=\"prereg-list\">\n      <li><strong>Be pre-registered and verified</strong> &mdash; the whitelists are built from the leaderboard inside yakkamon.com.</li>\n      <li><strong>Be at the rank you want.</strong> The snapshot on September 10 fixes which waves you're in.</li>\n      <li><strong>Deposit at least 5 $FLOWER</strong> if you're counting on Wave 2 or Wave 4. It's withdrawable; it exists to make multi-accounting expensive.</li>\n      <li><strong>Connect a Ronin wallet</strong> and hold some RON for gas.</li>\n    </ul>\n    <p>Then be online when your wave opens on the Ronin Launchpad. <a href=\"article-ronin-free-mint-guide.html#mint-day\">Mint day, step by step &rarr;</a></p>"
   },
   {
