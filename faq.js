 ...
 },
 {
  ...
  "items": [
   ...
   },
   {
    ...
    "a": "<p><strong>Wave 3</strong> of the free mint, on <strong>16 September</strong>: 2,000 hidden Genesis Yakkamon reserved for people already playing on Ronin. It is the one wave that ignores the Yakkamon leaderboard &mdash; no rank, no snapshot position and no $FLOWER deposit are needed. The team took a <strong>90-day on-chain snapshot ending 8 September</strong> across Axie Infinity (20,040 wallets), Craft World (14,422), Pixels (4,247), Ronkeverse (3,658) and Moku (2,354) &mdash; <strong>42,730 unique candidate wallets</strong> &mdash; and a Sunflower Land list is being added before the whitelist is finalised on <strong>10 September</strong>, together with a separate whitelist from the Ronin team. The lists are candidates, not the final whitelist: 42,730 wallets for 2,000 spots. <a href=\"article-ronin-wave.html\">The full breakdown &rarr;</a></p>"
   },
   {
   ...
   },
   {
    ...
    "a": "<p>The team published the method, not the formula. <strong>Active days matter most</strong> &mdash; how many different days you were on-chain in the 90-day window. Each signal is weighted and <strong>capped per day</strong>, so a hundred actions in one afternoon count like one busy day. <strong>Playing more than one of the games sorts you to the top</strong> of the mega list. Bot-like wallets stay in the file but rank last; custodial, guild and escrow wallets are discounted; contracts and sybil wallets are excluded. Holding NFTs without transacting shows as zero active days. The window closed on 8 September, so nothing you do now changes your score. <a href=\"article-ronin-wave.html#score\">The score in plain terms &rarr;</a></p>"
   },
   {
    "q": "I play Sunflower Land \u2014 am I in the Ronin Wave?",
    "id": "i-play-sunflower-land-am-i-in-the-ronin-wave",
    "a": "<p>Probably, but the list isn't out yet. The team says Sunflower Land players get their own place in Wave 3 and that the list will be published before the whitelists finalise on 10 September. It expects to count active farming on a Ronin farm over the same 90-day window, $FLOWER activity on Ronin, holding collectibles, Bumpkins and Farm NFTs, and marketplace trades. You also have a second route nobody else in the wave has: $FLOWER earned in Sunflower Land is the same token that unlocks Waves 2 and 4 &mdash; verify a Yakkamon account and deposit 5 $FLOWER before 10 September. <a href=\"article-ronin-wave.html#sunflower-land\">What to check &rarr;</a></p>"
   },
   {
    "q": "Does the Ronin Wave affect my rank or the airdrop?",
    "id": "does-the-ronin-wave-affect-my-rank-or-the-airdrop",
    "a": "<p>No. It does not touch the 10 September trainer snapshot for Waves 1, 2, 4 and 5, and it does not touch the Genesis airdrop leaderboard, which keeps running until one week before early access. What it adds is an extra mint: if the Ronin wallet linked to your Yakkamon account was also active in one of the five games, you can mint in Wave 3 on top of your rank waves &mdash; one per wallet per wave. The wallet on the list must be the wallet that mints, so if your Ronin gaming and your Yakkamon account use different wallets, decide now which one Wave 3 comes from. <a href=\"article-ronin-wave.html#trainers\">If you are a trainer &rarr;</a></p>"
   },
   {
