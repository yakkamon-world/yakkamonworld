 ...
 },
 {
  ...
  "items": [
   ...
   },
   {
    ...
    "a": "<p>A minted egg the team has flagged for rule-breaking. The mint sold out on September 17, but the team is <strong>still actively reviewing who minted</strong>: accounts that broke the rules &mdash; multi-account farming above all &mdash; get their minted eggs labeled with a <strong>&ldquo;Status: Bad Egg&rdquo;</strong> trait on the NFT itself, and a Bad Egg <strong>reveals nothing</strong> on October 14 &mdash; a sealed egg that is already known to be empty. There are <strong>365</strong> as of September 17, 2026 (up from 53 on September 15), and the count can keep climbing while the review runs. Anyone can see them: filter the official collection page by Status at <a href=\"https://marketplace.roninchain.com/collections/yakkamon?Status=Bad%20Egg\" target=\"_blank\" rel=\"noopener\">marketplace.roninchain.com/collections/yakkamon &#8599;</a>.</p>\n    <p><strong>Buying a sealed egg?</strong> Open the egg's own marketplace page and check its Status trait before paying &mdash; a Bad Egg trades like any other blind egg unless you look. If you minted fairly from one account, nothing about the review touches you. <a href=\"article-free-mint-complete.html#bad-eggs\">The Bad Egg hunt, in the completion report &rarr;</a></p>"
   },
   {
