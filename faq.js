...
var FAQ_CATEGORIES = [
 {
  ...
  "items": [
   ...
   },
   {
    ...
    "a": "<p><strong>Ronin</strong>, a blockchain built for games with much lower fees than networks like Ethereum. It's also where the free mint happens, on the Ronin Launchpad from <strong>September 14</strong>.</p>",
 ...
 },
 {
  ...
  "items": [
   ...
   },
   {
    ...
    "a": "<ul class=\"prereg-list\">\n      <li><strong>Daily nurture</strong> &mdash; tap your egg 3 times, once a day. Pays 6 points rising to <strong>10 a day</strong> at a 30-day streak, with a 36-hour grace period &mdash; though that only covers a whole missed day if you nurture after <a href=\"tips.html#streak-timing\">12:00 UTC</a>.</li>\n      <li><strong>Quests</strong> &mdash; link your Discord and Twitter/X accounts, post weekly, and take part in the community.</li>\n      <li><strong>Referrals</strong> &mdash; points for every friend who signs up through you.</li>\n      <li><strong>The free mint</strong> &mdash; minting on the Ronin Launchpad from September 14 earns <strong>250 points per mint</strong> &mdash; every wave you mint in pays its own, up to 1,250 &mdash; credited <a href=\"#i-minted-where-are-my-250-points\">once the minting period has ended</a> rather than on mint day (see <a href=\"#mint-vs-airdrop\">section 4</a>).</li>\n      <li><strong>$FLOWER deposits</strong> &mdash; <strong>open now</strong> (since Aug 9, 8:00 PM ET / Aug 10 UTC). Points are boosted two ways: a <strong>weekly multiplier</strong> paying <strong>3&times;</strong> through the opening week and falling 0.2&times; each week until it rests at 1&times; (week 3 held at 2.8&times; after the week-2 pause), plus a <strong>size bonus rated per deposit</strong> that doubles at every step &mdash; +10% at 50 $FLOWER up to <strong>+80%</strong> at 50,000. <a href=\"tips.html#weekly-flower\">The full schedule &rarr;</a></li>\n    </ul>\n    <p>Daily actions compound: streaks and referrals stack over time, so an early start is genuinely harder for someone else to overtake later.</p>\n    <div class=\"prereg-callout info\"><strong>The exact numbers:</strong> referrals pay <strong>75</strong> each &mdash; your first five instantly, and after that only once your friend has <strong>linked a wallet and deposited 100 $FLOWER</strong> &mdash; the free mint pays <strong>250 per mint</strong> (credited after mint week, not on mint day &mdash; up to 1,250 across five waves), and one-time quests (Discord, X, wallet) pay 10 each. Ninety days of perfect nurture is roughly 856 points. <a href=\"article-leaderboard-guideline.html\">Full leaderboard guideline &rarr;</a></div>",
 ...
 },
 {
  "id": "free-mint",
  "name": "Free mint",
  "intro": "<p><strong>The free mint is over.</strong> All <strong>10,000</strong> hidden Yakkamon were minted &mdash; the supply sold out during <strong>Wave 4</strong> on <strong>September 17, 2026</strong>, so Wave 5 (September 18) has nothing left to mint. Every egg stays sealed until the reveal on <strong>October 14</strong>; Ronin Market opens for trading on <strong>September 21</strong>, and until then OpenSea is the only live venue. The answers below are kept as the record of how the mint worked.</p><p>Everything below is from the official free mint page, the free-mint dev stream and, since September 10, the official whitelist page. <strong>The official mint page is live</strong> on Ronin Market at <a href=\"https://marketplace.roninchain.com/launchpads/mints/yakkamon\" target=\"_blank\" rel=\"noopener\">marketplace.roninchain.com/launchpads/mints/yakkamon &#8599;</a> &mdash; <a href=\"article-mint-page-live.html\">what the listing says</a>. <strong>The whitelist is live:</strong> check any wallet at <a href=\"https://yakkamon.com/whitelist\" target=\"_blank\" rel=\"noopener\">yakkamon.com/whitelist &#8599;</a>, and read <a href=\"article-whitelist-live.html\">what the page says, with every wave's opening time in your time zone</a>. For the whole thing in one place &mdash; which waves your rank unlocks, the pre-snapshot checklist and mint day step by step &mdash; read <a href=\"article-ronin-free-mint-guide.html\">The Ultimate Ronin Free Mint Guide</a>, or <a href=\"https://www.youtube.com/watch?v=iCOqW_yG0gA\" target=\"_blank\" rel=\"noopener\">watch the four-minute stream recap &#8599;</a>. Wave 3, the Ronin gamers' wave, has <a href=\"article-ronin-wave.html\">its own page</a>.</p>",
  "rich": "",
  "items": [
   {
    "q": "What is the free mint?",
    "id": "what-is-the-free-mint",
    "a": "<p>On <strong>September 14</strong> a free mint of <strong>10,000 hidden Genesis monster NFTs</strong> opens on the <strong>Ronin Launchpad</strong>. It runs in five whitelisted waves over five days, each open to a different slice of the leaderboard. Mint one and you're holding a sealed Yakkamon that is revealed on <strong>October 14</strong>. It costs nothing beyond the network fee (gas, in RON) &mdash; there's no mint price. The whitelists are final &mdash; the snapshot was taken on September 10 at 01:00 UTC &mdash; and you can check any wallet at <a href=\"https://yakkamon.com/whitelist\" target=\"_blank\" rel=\"noopener\">yakkamon.com/whitelist &#8599;</a>. <a href=\"article-ronin-free-mint-guide.html\">The full guide &rarr;</a> &middot; <a href=\"pre-registration.html#free-mint\">The wave table &rarr;</a></p>"
   },
   {
    "q": "When exactly, and what are the waves?",
    "id": "when-exactly-and-what-are-the-waves",
    "a": "<p><strong>The mint is over</strong> &mdash; the supply sold out during <strong>Wave 4</strong> on <strong>September 17, 2026</strong>, so all 10,000 were minted and <strong>Wave 5 never opened</strong>. <a href=\"article-free-mint-complete.html\">The completion report &rarr;</a> The schedule below is kept as the historical record: one wave a day from September 14, each with its own supply, its own list and &mdash; since the whitelist page went live on September 10 &mdash; its own opening hour and name. Waves 1, 2 and 5 opened at <strong>00:00 UTC</strong>; Waves 3 and 4 at <strong>08:00 UTC</strong>.</p>\n    <div class=\"table-scroll\"><table class=\"prereg-table\">\n      <tr><th>Wave</th><th>Opens (UTC)</th><th>Supply</th><th>Who</th><th>Status</th></tr>\n      <tr><td><strong>1 &middot; Top Trainers</strong></td><td>Sept 14, 00:00</td><td>1,000</td><td>Top 1,000 trainers &mdash; guaranteed, at your own pace; the supply matches the whitelist exactly</td><td><span class=\"fm-in\" data-fm-in=\"w1\">Sept 14, 00:00 UTC</span></td></tr>\n      <tr><td><strong>2 &middot; OG Trainers</strong></td><td>Sept 15, 00:00</td><td>3,000</td><td>Ranks 1&ndash;10,000 with a 5 $FLOWER minimum deposit &mdash; first come, first served</td><td><span class=\"fm-in\" data-fm-in=\"w2\">Sept 15, 00:00 UTC</span></td></tr>\n      <tr><td><strong>3 &middot; The Ronin Wave</strong></td><td>Sept 16, <strong>08:00</strong></td><td>2,000</td><td>Active Ronin gamers &mdash; wallets active in Axie, Craft World, Pixels, Ronkeverse, Moku or Sunflower Land in the 90 days to September 8, plus a Ronin-team whitelist. <a href=\"#what-is-the-ronin-wave\">More below &rarr;</a></td><td><span class=\"fm-in\" data-fm-in=\"w3\">Sept 16, 08:00 UTC</span></td></tr>\n      <tr><td><strong>4 &middot; Yakkamon Hunters</strong></td><td>Sept 17, <strong>08:00</strong></td><td>5,000</td><td>Ranks 1&ndash;20,000 with a 5 $FLOWER minimum deposit; ends early if the 10,000 sell out</td><td><span class=\"fm-in\" data-fm-in=\"w4\">Sept 17, 08:00 UTC</span></td></tr>\n      <tr><td><strong>5 &middot; Public Trainers</strong></td><td>Sept 18, 00:00</td><td>Remaining</td><td>Ranks 1&ndash;50,000, no deposit needed &mdash; only what the earlier waves left; it &ldquo;may never open if the supply is gone&rdquo;</td><td><span class=\"fm-in\" data-fm-in=\"w5\">Never opened</span></td></tr>\n    </table></div>\n    <p>00:00 UTC is 8:00 PM the evening before in New York and 5:00 PM in Los Angeles; 08:00 UTC is 4:00 AM in New York, 9:00 AM in London and 4:00 PM in Manila &mdash; <a href=\"article-whitelist-live.html#time-zones\">nine time zones here</a>. A further <strong>1,500</strong> hidden eggs are minted after the free mint and handed out at special events before the reveal on October 14, which has a date but no published hour yet &mdash; no eligibility for those 1,500 has been published. Times are from <a href=\"https://yakkamon.com/whitelist\" target=\"_blank\" rel=\"noopener\">yakkamon.com/whitelist &#8599;</a>; the docs' free mint page now points there for the full wave schedule.</p>"
   },
   {
    "q": "How do I check if I'm whitelisted?",
    "id": "how-do-i-check-if-i-m-whitelisted",
    "a": "<p>Open <a href=\"https://yakkamon.com/whitelist\" target=\"_blank\" rel=\"noopener\">yakkamon.com/whitelist &#8599;</a>, paste a wallet address &mdash; the <code>0x&hellip;</code> form or the <code>ronin:&hellip;</code> form, both work &mdash; and press Search. It lists every wave that wallet is whitelisted for, with the opening time of each. The lists are <strong>final</strong>: the snapshot behind Waves 1, 2, 4 and 5 was taken on <strong>September 10 at 01:00 UTC</strong>, and Wave 3 comes from the 90-day Ronin activity snapshot that ended September 8. For the trainer waves, check the Ronin wallet linked to your Yakkamon account; for the Ronin Wave, check whichever wallet did the playing, which may be a different one &mdash; check both if you have both. A Base address will not show anything, because nothing on Base mints. If the checker comes back empty, the lists will not change now; <a href=\"article-whitelist-live.html#not-listed\">what is left</a> is the marketplace, the 1,500 special-event hidden eggs and the top-5,000 pre-registration airdrop, which runs on its own later snapshot. <a href=\"article-whitelist-live.html#checker\">Using the checker &rarr;</a></p>"
   },
   {
    "q": "Where is the official mint page?",
    "id": "where-is-the-official-mint-page",
    "a": "<p>On Ronin Market: <a href=\"https://marketplace.roninchain.com/launchpads/mints/yakkamon\" target=\"_blank\" rel=\"noopener\">marketplace.roninchain.com/launchpads/mints/yakkamon &#8599;</a> &mdash; the listing is called the <strong>Yakkamon Genesis Mint</strong>, and it is the one page every wave mints from, September 14&ndash;18. The listing confirms the drop in its own words: 10,000 total supply, every NFT minted blind, all revealed October 14 with 68 Legendaries and 50 Rares in the pool, and minted Yakkamon can be deposited into the game once early access begins. <strong>Bookmark the exact address today</strong> and open it from the bookmark on mint day &mdash; never from a link in a DM or a reply, because look-alike pages appear around every popular mint. Whether <em>your</em> wallet can mint, and in which waves, is the <a href=\"https://yakkamon.com/whitelist\" target=\"_blank\" rel=\"noopener\">whitelist checker&rsquo;s &#8599;</a> job. <a href=\"article-mint-page-live.html\">What the listing says, line by line &rarr;</a></p>"
   },
   {
    "q": "Where do I buy or sell a minted Yakkamon?",
    "id": "where-do-i-buy-or-sell-a-minted-yakkamon",
    "a": "<p>On the collection page on Ronin Market: <a href=\"https://marketplace.roninchain.com/collections/yakkamon\" target=\"_blank\" rel=\"noopener\">marketplace.roninchain.com/collections/yakkamon &#8599;</a> &mdash; the official home for the whole <strong>Yakkamon</strong> collection, where every minted Yakkamon is viewed, listed, bought and sold. Keep it separate from the mint page: you <strong>mint</strong> on the Launchpad page (<a href=\"https://marketplace.roninchain.com/launchpads/mints/yakkamon\" target=\"_blank\" rel=\"noopener\">marketplace.roninchain.com/launchpads/mints/yakkamon</a>, whitelisted wallets only, one per wave, free plus gas), and you <strong>trade</strong> on the collection page (open to anyone with a Ronin wallet). You never mint from the collection page. Because every egg is minted blind and tradable before the <strong>October 14</strong> reveal, a market in sealed eggs runs on the collection page from the first mint until the reveal. Buying there means paying a seller&rsquo;s price for a blind egg &mdash; a real cost with no guaranteed reward, unlike the free mint. <a href=\"article-collection-page-live.html\">The collection page, explained &rarr;</a></p>"
   },
   {
    "q": "What time does each wave open in my time zone?",
    "id": "what-time-does-each-wave-open-in-my-time-zone",
    "a": "<p>Only two clock times mattered all week. <strong>Waves 1, 2 and 5 were scheduled for 00:00 UTC</strong> on September 14, 15 and 18; <strong>Waves 3 and 4 for 08:00 UTC</strong> on September 16 and 17.</p>\n    <div class=\"table-scroll\"><table class=\"prereg-table\">\n      <tr><th>Where you are</th><th>Waves 1, 2 and 5 (00:00 UTC)</th><th>Waves 3 and 4 (08:00 UTC)</th></tr>\n      <tr><td>Los Angeles (PDT)</td><td>5:00 PM, the evening before</td><td>1:00 AM</td></tr>\n      <tr><td>New York (EDT)</td><td>8:00 PM, the evening before</td><td>4:00 AM</td></tr>\n      <tr><td>London (BST)</td><td>1:00 AM</td><td>9:00 AM</td></tr>\n      <tr><td>Berlin / Paris (CEST)</td><td>2:00 AM</td><td>10:00 AM</td></tr>\n      <tr><td>Istanbul (TRT)</td><td>3:00 AM</td><td>11:00 AM</td></tr>\n      <tr><td>India (IST)</td><td>5:30 AM</td><td>1:30 PM</td></tr>\n      <tr><td>Jakarta (WIB)</td><td>7:00 AM</td><td>3:00 PM</td></tr>\n      <tr><td>Manila (PHT)</td><td>8:00 AM</td><td>4:00 PM</td></tr>\n      <tr><td>Sydney (AEST)</td><td>10:00 AM</td><td>6:00 PM</td></tr>\n    </table></div>\n    <p>The mint has ended &mdash; it sold out during Wave 4 on September 17 &mdash; so these hours are kept for the record. The two most contested click races &mdash; the Ronin Wave and Wave 4 &mdash; opened at an hour that was comfortable for Southeast Asia and the middle of the night for North America. Times from <a href=\"https://yakkamon.com/whitelist\" target=\"_blank\" rel=\"noopener\">yakkamon.com/whitelist &#8599;</a>.</p>"
   },
   {
   ...
   },
   {
    ...
    "a": "<p>You need to be inside the <strong>top 50,000</strong> on the leaderboard to be in any wave, and the higher you are the more waves you're on the list for, because the brackets nest. The rank that counted was your rank at the <strong>September 10 snapshot</strong>, taken at 01:00 UTC; the lists are final, so the sure way to see your waves now is the <a href=\"https://yakkamon.com/whitelist\" target=\"_blank\" rel=\"noopener\">official checker &#8599;</a>.</p>\n    <div class=\"table-scroll\"><table class=\"prereg-table\">\n      <tr><th>Rank on Sept 10</th><th>Waves</th><th>Needs 5 $FLOWER?</th><th>Points if you mint them all</th></tr>\n      <tr><td>1&ndash;1,000</td><td>1, 2, 4, 5 &mdash; Wave 1 guaranteed</td><td>For Waves 2 and 4</td><td>1,000</td></tr>\n      <tr><td>1,001&ndash;10,000</td><td>2, 4, 5</td><td>For Waves 2 and 4</td><td>750</td></tr>\n      <tr><td>10,001&ndash;20,000</td><td>4, 5</td><td>For Wave 4</td><td>500</td></tr>\n      <tr><td>20,001&ndash;50,000</td><td>5 only</td><td>No</td><td>250</td></tr>\n      <tr><td>50,001+</td><td>None from the leaderboard &mdash; Wave 3 only if your wallet makes the <a href=\"article-ronin-wave.html\">Ronin Wave</a> whitelist</td><td>&mdash;</td><td>250 via Wave 3</td></tr>\n    </table></div>"
   },
   {
    "q": "What is the Ronin Wave?",
    "id": "what-is-the-ronin-wave",
    "a": "<p><strong>Wave 3</strong> of the free mint, on <strong>September 16</strong>: 2,000 hidden Genesis Yakkamon reserved for people already playing on Ronin. It is the one wave that ignores the Yakkamon leaderboard &mdash; no rank, no snapshot position and no $FLOWER deposit are needed. The team took a <strong>90-day on-chain snapshot ending September 8</strong> across Axie Infinity (20,040 wallets), Craft World (14,422), Pixels (4,247), Ronkeverse (3,658) and Moku (2,354) &mdash; <strong>42,730 unique candidate wallets</strong> &mdash; then added Sunflower Land and a separate whitelist from the Ronin team before finalizing on <strong>September 10</strong>; the official whitelist page lists six games. The candidate lists were 42,730 wallets for 2,000 spots; the final answer for any wallet is on <a href=\"https://yakkamon.com/whitelist\" target=\"_blank\" rel=\"noopener\">yakkamon.com/whitelist &#8599;</a>. Wave 3 opens on <strong>September 16 at 08:00 UTC</strong>. <a href=\"article-ronin-wave.html\">The full breakdown &rarr;</a></p>"
   },
   {
    "q": "How do I check if I'm on the Ronin Wave list?",
    "id": "how-do-i-check-if-i-m-on-the-ronin-wave-list",
    "a": "<p>Since September 10 there is one answer: open <a href=\"https://yakkamon.com/whitelist\" target=\"_blank\" rel=\"noopener\">yakkamon.com/whitelist &#8599;</a>, paste your Ronin address &mdash; <code>0x&hellip;</code> or <code>ronin:&hellip;</code>, both work &mdash; and press Search. It lists every wave the wallet is whitelisted for, the Ronin Wave included, and the lists are final. Craft World players: the game makes an embedded smart wallet for you, so check the Ronin Wallet address you would actually mint from; if your Ronin gaming and your Yakkamon account use different wallets, check both. The candidate lists on the official <a href=\"https://docs.yakkamon.com/pre-registration/free-mint/ronin-wave\" target=\"_blank\" rel=\"noopener\">Ronin Wave page &#8599;</a> &mdash; CSV files with rank, score and active days &mdash; are superseded by the checker. <a href=\"article-whitelist-live.html#checker\">Using the checker &rarr;</a></p>"
   },
   {
    "q": "How is the Ronin Wave score worked out?",
    "id": "how-is-the-ronin-wave-score-worked-out",
    "a": "<p>The team published the method, not the formula. <strong>Active days matter most</strong> &mdash; how many different days you were on-chain in the 90-day window. Each signal is weighted and <strong>capped per day</strong>, so a hundred actions in one afternoon count like one busy day. <strong>Playing more than one of the games sorts you to the top</strong> of the mega list. Bot-like wallets stay in the file but rank last; custodial, guild and escrow wallets are discounted; contracts and sybil wallets are excluded. Holding NFTs without transacting shows as zero active days. The window closed on September 8, so nothing you do now changes your score. <a href=\"article-ronin-wave.html#score\">The score in plain terms &rarr;</a></p>"
   },
   {
    "q": "I play Sunflower Land \u2014 am I in the Ronin Wave?",
    "id": "i-play-sunflower-land-am-i-in-the-ronin-wave",
    "a": "<p>Yes, if your farm was active enough. Sunflower Land is one of the six games on the official whitelist page, alongside Axie Infinity, Pixels, Craft World, Ronkeverse and Moku, and <a href=\"https://yakkamon.com/whitelist\" target=\"_blank\" rel=\"noopener\">yakkamon.com/whitelist &#8599;</a> is the first place SFL players can see whether their wallet made the 2,000. The team said it would count active farming on a Ronin farm over the 90-day window to September 8, $FLOWER activity on Ronin, holding collectibles, Bumpkins and Farm NFTs, and marketplace trades. The second route SFL players had &mdash; a verified Yakkamon account with 5 $FLOWER deposited, for Waves 2 and 4 &mdash; closed with the September 10 snapshot. Wave 3 opens on September 16 at 08:00 UTC. <a href=\"article-ronin-wave.html#sunflower-land\">What the team said &rarr;</a></p>"
   },
   {
    "q": "Does the Ronin Wave affect my rank or the airdrop?",
    "id": "does-the-ronin-wave-affect-my-rank-or-the-airdrop",
    "a": "<p>No. It does not touch the September 10 trainer snapshot for Waves 1, 2, 4 and 5, and it does not touch the Genesis airdrop leaderboard, which keeps running until one week before early access. What it adds is an extra mint: if the Ronin wallet linked to your Yakkamon account was also active in one of the five games, you can mint in Wave 3 on top of your rank waves &mdash; one per wallet per wave. The wallet on the list must be the wallet that mints, so if your Ronin gaming and your Yakkamon account use different wallets, check both on <a href=\"https://yakkamon.com/whitelist\" target=\"_blank\" rel=\"noopener\">yakkamon.com/whitelist &#8599;</a> and mint Wave 3 from the one it lists. <a href=\"article-ronin-wave.html#trainers\">If you are a trainer &rarr;</a></p>"
   },
   {
    "q": "Do I need to do anything before mint day?",
    "id": "do-i-need-to-do-anything-before-mint-day",
    "a": "<p>The September 10 deadline has passed &mdash; the snapshot was taken at 01:00 UTC and the whitelists are final &mdash; so the list is shorter now:</p>\n    <ul class=\"prereg-list\">\n      <li><strong>Check your wallet</strong> at <a href=\"https://yakkamon.com/whitelist\" target=\"_blank\" rel=\"noopener\">yakkamon.com/whitelist &#8599;</a>. It shows every wave that wallet can mint in. If you play other Ronin games, check that wallet too.</li>\n      <li><strong>Hold some RON</strong> for gas in the whitelisted wallet, bought the day before rather than at wave open.</li>\n      <li><strong>Know your hour.</strong> Waves 1, 2 and 5 open at 00:00 UTC, Waves 3 and 4 at 08:00 UTC &mdash; <a href=\"#what-time-does-each-wave-open-in-my-time-zone\">in your time zone</a>.</li>\n      <li><strong>Bookmark the official mint page</strong> &mdash; <a href=\"https://marketplace.roninchain.com/launchpads/mints/yakkamon\" target=\"_blank\" rel=\"noopener\">marketplace.roninchain.com/launchpads/mints/yakkamon &#8599;</a> &mdash; and open it from the bookmark on the day, never from a link someone sends you.</li>\n    </ul>\n    <p>The four pre-snapshot steps &mdash; verify, reach the rank, deposit 5 $FLOWER, link a Ronin wallet &mdash; are kept in <a href=\"article-ronin-free-mint-guide.html#checklist\">the guide</a> for the record. <a href=\"article-ronin-free-mint-guide.html#mint-day\">Mint day, step by step &rarr;</a></p>"
   },
   {
    "q": "Can I mint more than once?",
    "id": "can-i-mint-more-than-once",
    "a": "<p>Yes &mdash; <strong>one NFT per wave per account</strong>, and you can mint in every wave you qualify for. A top-1,000 trainer with 5 $FLOWER deposited is on the list for Waves 1, 2, 4 and 5. The team said this directly: the higher up the leaderboard you are, the more chances you get.</p>\n\n    <p>And each mint pays its own <strong>250 points</strong> &mdash; the 250 is per mint, not once per trainer &mdash; so the waves stack twice over: more chances at a Legendary, and more points toward your final rank. <a href=\"#how-many-points-is-the-free-mint-worth-in-total\">What the waves add up to &rarr;</a></p>"
   },
   {
    "q": "What does the 5 $FLOWER deposit do?",
    "id": "what-does-the-5-flower-deposit-do",
    "a": "<p>It was the eligibility condition for Waves 2 and 4 &mdash; it had to be deposited before the September 10 snapshot (01:00 UTC), and a deposit made now no longer changes the lists. It was added at the Ronin team's suggestion to stop multi-accounting &mdash; free mints &ldquo;get botted heavily&rdquo; without a cost like this. The deposit stays yours: withdrawable, or spendable in the game whenever you want. More than 3,000 trainers in the top 10,000 had already met it when the stream aired.</p>"
   },
   {
    "q": "Do I get to see what I minted?",
    "id": "do-i-get-to-see-what-i-minted",
    "a": "<p>Not straight away. You're minting <strong>blind</strong> &mdash; all 10,000 stay sealed until <strong>October 14</strong>, when every one is revealed at once. That's before the leaderboard finalizes, so you'll know what you're holding while you can still climb. Hidden NFTs are <strong>tradable before the reveal</strong> as well as after.</p>"
   },
   {
    "q": "What is a Bad Egg?",
    "id": "what-is-a-bad-egg",
    "a": "<p>A minted egg the team has flagged for rule-breaking. Accounts that broke the rules &mdash; multi-account farming above all &mdash; get their minted eggs labeled with a <strong>&ldquo;Status: Bad Egg&rdquo;</strong> trait on the NFT itself, and a Bad Egg <strong>reveals nothing</strong> on October 14 &mdash; a sealed egg that is already known to be empty. There are <strong>973</strong> as of the September 17 dev stream (up from 53 on September 15) &mdash; close to one minted egg in ten. The team called that review <strong>essentially complete</strong>: a few more flags can still land, but no big wave is expected. Anyone can see them: filter the official collection page by Status at <a href=\"https://marketplace.roninchain.com/collections/yakkamon?Status=Bad%20Egg\" target=\"_blank\" rel=\"noopener\">marketplace.roninchain.com/collections/yakkamon &#8599;</a>.</p>\n    <p>The upside for everyone who played fair: the <strong>68 Legendaries and 50 Rares will not be distributed among Bad Eggs</strong> &mdash; they land in clean eggs only, so every flagged egg improved honest minters&rsquo; reveal odds.</p>\n    <p><strong>Buying a sealed egg?</strong> Open the egg's own marketplace page and check its Status trait before paying &mdash; a Bad Egg trades like any other blind egg unless you look. If you minted fairly from one account, nothing about the review touches you. <a href=\"article-dev-stream-sept-17-recap.html#bad-eggs\">The full enforcement update, from the stream &rarr;</a></p>"
   },
   {
   ...
   },
   {
    ...
    "a": "<p><strong>It didn't.</strong> All week the answer was &ldquo;only if an earlier wave doesn't sell out&rdquo; &mdash; and since September 10 that was the official position too: the whitelist page said Wave 5, &ldquo;Public Trainers,&rdquo; gets &ldquo;only what the earlier waves left&rdquo; and &ldquo;may never open if the supply is gone.&rdquo; The headline wave sizes add up to <strong>11,000 for 10,000 NFTs</strong>: if Waves 1&ndash;3 sell out, Wave 4 opens with 4,000 rather than 5,000 (the docs say it ends early once the 10,000 are gone), and if Wave 4 sells out too, Wave 5 opens with nothing. The swing is Wave 4 &mdash; it needs most of the roughly 5,200 depositing wallets to mint a second day running. The question was settled on <strong>September 17</strong>: the supply sold out during Wave 4, so <strong>Wave 5 never opened</strong> &mdash; exactly the outcome <a href=\"article-free-mint-by-the-numbers.html#wave-5\">the arithmetic</a> pointed to. <a href=\"article-free-mint-complete.html\">The completion report &rarr;</a></p>"
   },
   {
    "q": "Why bother if I'm already pre-registered?",
    "id": "why-bother-if-i-m-already-pre-registered",
    "a": "<p>Because it's a free NFT from the collection that <em>is</em> the Yakkamon collection &mdash; when new Yakkamon are released into the wild they appear in this same collection &mdash; and it's tradable from the day you mint it, seven weeks before early access. And minting <strong>earns 250 pre-registration points per mint</strong> &mdash; more than three referrals for one click, and <a href=\"#how-many-points-is-the-free-mint-worth-in-total\">up to 1,250</a> if you are on every wave &mdash; so it feeds straight back into your airdrop band and early-access wave &mdash; <a href=\"#i-minted-where-are-my-250-points\">once the minting period has ended</a>, which is when those points are credited.</p>"
   },
   {
   ...
   },
   {
    ...
    "a": "<p>Hold it, trade it on the Ronin marketplace, or wait for the October 14 reveal. Once early access begins (November/December) you can deposit minted monsters into Yakkamon and play with them; the official page says the total revealed on October 14 is <strong>11,500</strong> &mdash; the 10,000 minted plus 1,500 extra hidden eggs handed out at special events.</p>\n\n    <div class=\"prereg-callout warning\"><strong>The free mint and the Genesis airdrop are not the same thing.</strong> The mint is 10,000 hidden monsters, claimed by you in rank-gated waves from September 14. The airdrop (also called the <strong>Trainer Point airdrop</strong>) is 5,010 monsters to the top 5,000 on final rank, landing automatically three days after the leaderboard locks. You can receive both &mdash; see <a href=\"#mint-vs-airdrop\">section 4</a>.</div>"
   },
   {
    "q": "What are the extra 1,500 hidden eggs?",
    "id": "what-are-the-extra-1-500-hidden-eggs",
    "a": "<p>Beyond the 10,000 you mint, the team mints an <strong>extra 1,500 hidden-egg NFTs</strong> after the free mint and hands them out through <strong>special events</strong> before the October 14 reveal. That is why the official page gives the reveal total as <strong>11,500</strong> rather than 10,000. They are the same kind of sealed, tradable Genesis egg &mdash; you just win one at an event rather than minting it in a wave.</p>\n    <p>No eligibility, dates or rarity split for those 1,500 have been published, so there is nothing to sign up for yet &mdash; watch the official <a href=\"https://x.com/yakkamon_game\" target=\"_blank\" rel=\"noopener\">@yakkamon_game</a> and the <a href=\"https://docs.yakkamon.com/pre-registration/free-mint\" target=\"_blank\" rel=\"noopener\">free mint docs page</a> for the events. See the <a href=\"pre-registration.html#free-mint\">free mint on the Early Access page</a> and <a href=\"article-ronin-free-mint-guide.html\">the full guide</a>.</p>"
   },
   {
   ...
   },
   {
    ...
    "a": "<p><strong>Yes.</strong> Base was fine for deposits &mdash; the points count the same, and a 5 $FLOWER deposit on Base satisfied the Wave 2 and 4 condition &mdash; but the mint happens <strong>only on Ronin</strong>, through the Ronin Launchpad. The wallet that mints is the Ronin wallet linked to your Yakkamon account; paste it into <a href=\"https://yakkamon.com/whitelist\" target=\"_blank\" rel=\"noopener\">yakkamon.com/whitelist &#8599;</a> to see which waves it is on, and hold some RON in it <strong>before your wave opens</strong>. A Base wallet cannot mint, however verified the trainer behind it is.</p>"
   },
   {
    "q": "How do I actually mint on the day?",
    "a": "<p>Buy a little <strong>RON</strong> for gas days ahead. On the day, open the official mint page &mdash; <a href=\"https://marketplace.roninchain.com/launchpads/mints/yakkamon\" target=\"_blank\" rel=\"noopener\">marketplace.roninchain.com/launchpads/mints/yakkamon &#8599;</a>, the &ldquo;Yakkamon Genesis Mint&rdquo; on Ronin Market &mdash; from your own bookmark, not from a link in a DM or a reply, connect the Ronin wallet you linked to your Yakkamon account, and have the page loaded before your wave opens. Click mint, approve the transaction in your wallet, and the hidden NFT lands in that wallet once it confirms. Come back for every wave you qualify for. Every wave has a published opening time now: 00:00 UTC for Waves 1, 2 and 5, 08:00 UTC for Waves 3 and 4. One thing not to worry about on the day: the <strong>+250 points</strong> do not appear on your trainer dashboard straight away &mdash; they <a href=\"#i-minted-where-are-my-250-points\">land once the minting period has ended</a>. <a href=\"article-ronin-free-mint-guide.html\">The step-by-step guide &rarr;</a></p>",
    "id": "how-do-i-actually-mint-on-the-day"
   },
   {
    "q": "How many points is the free mint worth in total?",
    "a": "<p>250 <strong>per mint</strong>, and you can mint once in every wave you qualify for &mdash; so what the mint is worth depends entirely on how many waves you are on. The ceiling is <strong>1,250</strong>, for a top-1,000 trainer who deposited 5 $FLOWER and whose wallet also made the <a href=\"article-ronin-wave.html\">Ronin Wave</a> list.</p>\n\n    <div class=\"table-scroll\"><table class=\"prereg-table\">\n      <tr><th>Your situation at the September 10 snapshot</th><th>Waves</th><th>Mints</th><th>Points</th></tr>\n      <tr><td>Top 1,000, 5 $FLOWER deposited, and a Ronin gamer</td><td>1, 2, 3, 4, 5</td><td>5</td><td><strong>1,250</strong></td></tr>\n      <tr><td>Top 1,000 with 5 $FLOWER deposited</td><td>1, 2, 4, 5</td><td>4</td><td><strong>1,000</strong></td></tr>\n      <tr><td>Ranks 1,001&ndash;10,000 with 5 $FLOWER</td><td>2, 4, 5</td><td>3</td><td><strong>750</strong></td></tr>\n      <tr><td>Ranks 10,001&ndash;20,000 with 5 $FLOWER</td><td>4, 5</td><td>2</td><td><strong>500</strong></td></tr>\n      <tr><td>Ranks 20,001&ndash;50,000, no deposit</td><td>5 only</td><td>1</td><td><strong>250</strong></td></tr>\n      <tr><td>Not on the leaderboard, but a Ronin gamer</td><td>3 only</td><td>1</td><td><strong>250</strong></td></tr>\n    </table></div>\n\n    <div class=\"prereg-callout warning\"><strong>These are ceilings, not expectations.</strong> Only Wave 1 is guaranteed. Every other wave is first come, first served against a supply that runs out &mdash; the five wave supplies added up to 11,000 against a collection of 10,000, so <a href=\"article-free-mint-by-the-numbers.html#wave-5\">Wave 5 was never guaranteed</a> &mdash; and indeed the supply sold out during Wave 4 on September 17, so <strong>Wave 5 never opened</strong>. A wave you missed pays nothing.</div>\n\n    <p>The points land on the trainer dashboard <a href=\"#i-minted-where-are-my-250-points\">once the minting period has ended</a>, not as you mint, so you will not see them climb wave by wave.</p>",
    "id": "how-many-points-is-the-free-mint-worth-in-total"
   },
   {
    "q": "I minted &mdash; where are my 250 points?",
    "a": "<p>Nothing has gone wrong. The team confirmed on Discord on September 13 that the <strong>+250 points</strong> land on the trainer dashboard <strong>&ldquo;once the minting period has ended&rdquo;</strong> &mdash; not at the moment you mint. A dashboard that hasn&rsquo;t moved on the 14th is expected: the mint still counts, so there is no need to mint again from another wallet or to open a support ticket.</p>\n\n    <p>One thing is now settled: the minting period <strong>ended September 17, 2026</strong>, when the supply sold out during Wave 4 &mdash; <a href=\"#does-wave-5-actually-exist\">Wave 5 never opened</a>. What the announcement never gave is an hour for the points landing. Also settled: the 250 is paid <strong>per mint</strong>, not once per trainer, so every wave you mint in pays its own 250. <a href=\"#how-many-points-is-the-free-mint-worth-in-total\">What that adds up to &rarr;</a></p>\n\n    <div class=\"prereg-callout info\">The wait costs you nothing. The leaderboard does not finalize until <strong>a week before early access</strong> in November or December, so points credited in the days after mint week still count toward the rank your airdrop is paid on. <a href=\"article-ronin-free-mint-guide.html#after-you-mint\">What happens after you mint &rarr;</a></div>",
    "id": "i-minted-where-are-my-250-points"
   },
   {
    "q": "Is the September 10 snapshot the same as the leaderboard lock?",
    "a": "<p>No, and this catches people out. The <strong>September 10 snapshot</strong> (taken at 01:00 UTC) only built the <em>mint</em> whitelists &mdash; it fixed which waves you can mint in and nothing else. The <strong>leaderboard lock</strong> that decides your Genesis airdrop monster, your trainer number and your early-access wave comes later: one week before early access, with the airdrop landing three days after that. So you can keep climbing after September 10, and the 250 points from minting &mdash; which <a href=\"#i-minted-where-are-my-250-points\">appear once the minting period has ended</a>, not on mint day &mdash; count toward that later lock.</p>",
    "id": "is-the-10-september-snapshot-the-same-as-the-leaderboard-lock"
   },
   {
    "q": "How do I know a mint link is real?",
    "a": "<p>The mint is free, so anything asking for a price, a deposit or approval over your whole wallet is not Yakkamon. Mint only at the official page &mdash; <strong>marketplace.roninchain.com/launchpads/mints/yakkamon</strong> &mdash; bookmark it now and check the domain character by character, because look-alike launchpads appear around every popular free mint. The team will not DM you a link, an early mint or a &ldquo;whitelist fix&rdquo;, and nobody legitimate ever needs your recovery phrase. If you are new to Ronin, keep only the RON you need for gas in the wallet you mint with, and read every wallet prompt before approving it.</p>",
 ...
 },
 {
  ...
  "items": [
   ...
   },
   {
    ...
    "a": "<p>The rate steps down every week, so it depends when you read this. Week one (Aug 10&ndash;16) paid <strong>3&times;</strong>, and it normally falls 0.2&times; each week &mdash; with one exception: depositing was paused during week 2, so week 3 (Aug 24&ndash;30) was held at <strong>2.8&times;</strong> and the schedule shifted a week, resting at 1&times; from around October 26. The <a href=\"article-flower-deposit-guideline.html\">deposit guideline</a> carries the full week-by-week table with a live indicator showing the current rate.</p>",
 ...
 },
 {
  ...
  "items": [
   ...
   },
   {
    ...
    "a": "<p>No. <strong>&ldquo;We're not doing wearable gear for this game. The Yakkamon have the stats.&rdquo;</strong> There may be a single held item in the Pok&eacute;mon mold &mdash; one thing granting one passive &mdash; but no clothes and no equipment slots. Stats are set at generation from genetics and training values and improve through time invested, training and breeding. The buffs in this game come from the monsters themselves, not from what they wear.</p>"
   },
   {
